...
public class ProxyServiceOutgoingEidasResponseLoggerFilterTest {
    ...
    private void setUpBeanProvider(ProxyServiceOutgoingEidasResponseLogger mockProxyServiceOutgoingEidasResponseLogger) {
     ...
     */
    @Test
    public void doFilterNonProcessedJspURI() throws IOException, ServletException, EIDASSAMLEngineException {
        Mockito.when(mockHttpServletRequest.getRequestURI()).thenReturn("nonJspURI.notJsp");
        ...
        assertThat(traceAppender.list.size(), is(0));
    }
    ...
    public void doFilterServletException() throws IOException, EIDASSAMLEngineException {
        ...
        try {
            Logger messageLogger = getMessageLogger();
            doNothing().when(mockProxyServiceOutgoingEidasResponseLogger).logMessage(messageLogger, mockHttpServletRequest);
    ...
    public void doFilterEIDASSAMLEngineException() throws ServletException, IOException, EIDASSAMLEngineException {
        ...
        Logger messageLogger = getMessageLogger();
        doThrow(new EIDASSAMLEngineException("")).when(mockProxyServiceOutgoingEidasResponseLogger).logMessage(messageLogger, mockHttpServletRequest);
        proxyServiceOutgoingEidasResponseLoggerFilter.doFilter(mockHttpServletRequest, mockHttpServletResponse, mockFilterChain);
