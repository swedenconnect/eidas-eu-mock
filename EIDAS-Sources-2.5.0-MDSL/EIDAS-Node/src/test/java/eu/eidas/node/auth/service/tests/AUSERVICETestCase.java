...
public class AUSERVICETestCase {
    ...
    public void testValidateIdpResponseWithWhitespaceInUID() throws Throwable {
        ...
        try {
            ...
            Assert.assertTrue(e.getCause() instanceof InvalidParameterEIDASException);
            String expectedErrorCode = EidasErrorKey.INVALID_ATTRIBUTE_VALUE.errorCode();
            String actualErrorCode = ((InvalidParameterEIDASException) e.getCause()).getErrorCode();
    ...
    public void testUpdateResponseAttributes()
        ...
        ImmutableAttributeMap result = getImmutableAttributeMapUpdatedResponseAttributes(
                countryCode, originCountryCode, true, EidasSpec.Definitions.PERSON_IDENTIFIER);
    ...
    public void testUpdateResponseAttributesNoPrefix()
        ...
        ImmutableAttributeMap result = getImmutableAttributeMapUpdatedResponseAttributes(
                countryCode, originCountryCode,false, EidasSpec.Definitions.PERSON_IDENTIFIER);
    ...
    public void testUpdateResponseAttributesFail()
        ...
        ImmutableAttributeMap result = getImmutableAttributeMapUpdatedResponseAttributes(
                countryCode, originCountryCode, true, personIdentifier);
        ...
        result = getImmutableAttributeMapUpdatedResponseAttributes(
                countryCode, originCountryCode, true, legalPersonIdentifier);
     ...
     * Gender UNSPECIFIED should be replaced by Gender NOT_SPECIFIED for protocol version 1.1
     *
     * Must succeed.
     */
    @Test
    public void testUpdateResponseAttributesGenderShouldBeAdaptedForProtocolVersion1_1()
        ...
        final ProtocolEngineI mockedSamlEngine = Mockito.mock(ProtocolEngineI.class);
        ProtocolProcessorI mockedProtocolProcessor = Mockito.mock(ProtocolProcessorI.class);
        Mockito.when(mockedProtocolProcessor.getMetadataProtocolVersions(TestingConstants.REQUEST_ISSUER_CONS.toString()))
                .thenReturn(Arrays.asList(EidasProtocolVersion.PROTOCOL_VERSION_1_1));
        ...
        Gender actualValue = resultMap.getAttributeValues(genderAttributeDefinition).asList().get(0).getValue();
        Assert.assertEquals(Gender.NOT_SPECIFIED, actualValue);
    }

    /**
     * Test method for {@link AUSERVICE#updateResponseAttributes(IAuthenticationRequest, ImmutableAttributeMap)}  to
     * check if a GENDER attribute in the EidasAuthenticationResponse is changed depending of the protocol versions
     * Gender NOT_SPECIFIED should be replaced by Gender UNSPECIFIED for protocol version 1.2
     *
     * Must succeed.
     */
    @Test
    public void testUpdateResponseAttributesGenderShouldBeAdaptedForProtocolVersion1_2()
            throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, AttributeValueMarshallingException {
        final AUSERVICE underTest = new AUSERVICE();
        AUSERVICESAML auservicesaml = Mockito.mock(AUSERVICESAML.class);
        Mockito.when(auservicesaml.getCountryCode()).thenReturn("EU");
        ...
        ProtocolProcessorI mockedProtocolProcessor = Mockito.mock(ProtocolProcessorI.class);
        Mockito.when(mockedProtocolProcessor.getMetadataProtocolVersions(TestingConstants.REQUEST_ISSUER_CONS.toString()))
                .thenReturn(Arrays.asList(EidasProtocolVersion.PROTOCOL_VERSION_1_2));
        Mockito.when(mockedSamlEngine.getProtocolProcessor()).thenReturn(mockedProtocolProcessor);
        Mockito.when(auservicesaml.getSamlEngine()).thenReturn(mockedSamlEngine);
        underTest.setSamlService(auservicesaml);
        ...
        AttributeDefinition<Gender> genderAttributeDefinition = EidasSpec.Definitions.GENDER;
        AttributeValue<Gender> genderAttributeValue = genderAttributeDefinition.getAttributeValueMarshaller()
                .unmarshal(Gender.NOT_SPECIFIED.getValue(), false);
        ImmutableAttributeMap attributeMap =
                ImmutableAttributeMap.of(genderAttributeDefinition, genderAttributeValue);
        ...
        Assert.assertEquals(1, resultMap.getAttributeValues(genderAttributeDefinition).size());
        Gender actualValue = resultMap.getAttributeValues(genderAttributeDefinition).asList().get(0).getValue();
        Assert.assertEquals(Gender.UNSPECIFIED, actualValue);
    }
     ...
     */
    @Test
    public void testUpdateResponseAttributesGenderShouldBeAdaptedForProtocolVersionEmpty()
            throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, AttributeValueMarshallingException {
        final AUSERVICE underTest = new AUSERVICE();
        AUSERVICESAML auservicesaml = Mockito.mock(AUSERVICESAML.class);
        Mockito.when(auservicesaml.getCountryCode()).thenReturn("EU");
    ...
    private ImmutableAttributeMap getImmutableAttributeMapUpdatedResponseAttributes(final String countryCode,
            final String originCountryCode, final boolean isPrefixIdentifiers, AttributeDefinition<String> identifier)
        ...
        ImmutableAttributeMap attributeMap =
            ImmutableAttributeMap.of(identifier, new StringAttributeValue("12345678", false));
