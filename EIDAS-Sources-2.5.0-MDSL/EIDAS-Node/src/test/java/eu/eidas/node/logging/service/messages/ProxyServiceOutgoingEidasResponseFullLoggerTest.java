 ...
 * @since 2.5
 */
public class ProxyServiceOutgoingEidasResponseFullLoggerTest {
    ...
    public void setup() {
        ...
        proxyServiceOutgoingEidasResponseLogger.setMessageLoggerUtils(mockedMessageLoggerUtils);

        logAppender = LoggerTestUtils.createStartListAppender(new LevelFilter(Level.INFO, Level.ERROR));
        testedLogger = (Logger) ReflectionTestUtils.getField(proxyServiceOutgoingEidasResponseLogger, "fullLogger");
    ...
    /**
     * Test method for {@link ProxyServiceOutgoingEidasResponseLogger#logFullMessage(HttpServletRequest)}.
    ...
    public void logFullMessageActive() {
        ...
        proxyServiceOutgoingEidasResponseLogger.logFullMessage(testRequest);
     ...
     */
    @Test
    public void logFullMessageUTF_16BE() {
        String request = new String(readFileAsByteArray("logging/testFullLoggingEidasResponse.xml"));
    ...
    public void logFullMessageInvalidRequest() {
        ...
        ILoggingEvent actualLogEvent = logAppender.list.get(0);
        Level expectedErrorLevel = Level.ERROR;
        String expectedMessage = "Could not log the outgoing response because of ";
