...
public class AbstractProtocolSignerTest {
     ...
     */
    @Test
    public void testValidateCertificateSignatureHash() throws CertificateException, FileNotFoundException {
    ...
    private void testValidateCertificateSignatureHash(String sigAlgName) {
    ...
    private void testValidCertificateSignatureHash(X509Certificate certificate) {
        AbstractProtocolSigner signer = Mockito.mock(AbstractProtocolSigner.class);
        ReflectionUtils.invokeMethod(VALIDATE_CERTIFICATE_SIGNATURE_HASH_METHOD, signer, certificate);
    }
