...
public class EidasAuthResponseTest {
    ...
    public final void testResponseInvalidParametersIPDistinct() throws EIDASSAMLEngineException {
        ...
        IResponseMessage responseMessage = getEngine().generateResponseMessage(authenRequest, responseBuilder.build(), false, ipAddress);
    ...
    public final void testValidateAuthnResponse() throws EIDASSAMLEngineException {
        ...
        IResponseMessage responseMessage =
                getEngine().generateResponseMessage(authenRequest, responseBuilder.build(), false, ipAddress);
