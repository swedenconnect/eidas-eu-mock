...
public class DistributedMetadataCachingTest {
    ...
    /**
     * Test method for
     * {@link DistributedMetadataCaching#getMap()}
    ...
    /**
     * Test method for
     * {@link DistributedMetadataCaching#getCacheName()}
     * when the map field references an instance of a {@link ConcurrentMap}
    ...
    /**
     * Test method for
     * {@link DistributedMetadataCaching#setCacheName(String)}
     * when the cacheName field is not set before.
     * <p/>
     * Must succeed.
     */
    ...
    /**
     * Test method for
     * {@link DistributedMetadataCaching#getHazelcastInstanceInitializer()}
    ...
    /**
     * Test method for
     * {@link DistributedMetadataCaching#setHazelcastInstanceInitializer(HazelcastInstanceInitializer)}
     * when the hazelcastInstanceInitializer field is not set before.
     * <p/>
     * Must succeed.
     */
