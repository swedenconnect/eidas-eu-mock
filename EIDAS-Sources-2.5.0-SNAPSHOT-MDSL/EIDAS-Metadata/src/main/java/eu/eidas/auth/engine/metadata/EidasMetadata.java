...
public class EidasMetadata {
    ...
    public static final class Generator {
        ...
        private Extensions generateIDPSSODescriptorExtensions() throws EIDASMetadataException {
            ...
            generateNodeCountry(idpSSODescriptorExtensions);
        ...
        private Extensions generateSPSSODescriptorExtensions() throws EIDASMetadataException {
            ...
            generateNodeCountry(spSSODescriptorExtensions);
        ...
        private void generateNodeCountry(Extensions eidasExtensions) throws EIDASMetadataException {
            if (!StringUtils.isEmpty(nodeCountry)) {
                final NodeCountryType nodeCountryObj = (NodeCountryType) MetadataBuilderFactoryUtil
                        .buildXmlObject(NodeCountryType.DEF_ELEMENT_NAME);
                if (nodeCountryObj != null) {
                    nodeCountryObj.setNodeCountry(nodeCountry);
                    eidasExtensions.getUnknownXMLObjects().add(nodeCountryObj);
                } else {
        ...
        private void generateSPSSODescriptor(final EntityDescriptor entityDescriptor,
            ...
            fillNameIDFormat(spSSODescriptor, additionalNameIDFormats);
            spSSODescriptor.setExtensions(generateSPSSODescriptorExtensions());
            entityDescriptor.getRoleDescriptors().add(spSSODescriptor);

        }

        private void fillNameIDFormat(SSODescriptor ssoDescriptor, Set<String> additionalNameIdFormats) throws EIDASMetadataException {
        ...
        private void generateIDPSSODescriptor(final EntityDescriptor entityDescriptor,
            ...
            fillNameIDFormat(idpSSODescriptor, additionalNameIDFormats);
            ...
            idpSSODescriptor.setExtensions(generateIDPSSODescriptorExtensions());
