    ...
    private String generateMetadata(boolean idpRole, String url, ContactData technicalContact,
        ...
        if (url != null && !url.isEmpty()) {
            try {
                ...
                eidasMetadataRoleParameters.setEncryptionAlgorithms(getNodeProps().getProperty(EncryptionKey.ENCRYPTION_ALGORITHM_WHITE_LIST.getKey()));
                ...
                String signatureAlgorithmWhiteList = getNodeProps().getProperty(SignatureKey.SIGNATURE_ALGORITHM_WHITE_LIST.getKey());
                if (StringUtils.isBlank(signatureAlgorithmWhiteList)) {
                    signatureAlgorithmWhiteList = String.join(EIDASValues.SEMICOLON.toString(), EidasSignatureConstants.DEFAULT_SIGNATURE_ALGORITHM_WHITE_LIST);
                }
                eidasMetadataParametersI.setSigningMethods(signatureAlgorithmWhiteList);
                String digestMethodAlgorithmWhiteList = getNodeProps().getProperty(SignatureKey.DIGEST_METHOD_ALGORITHM_WHITELIST.getKey());
                if (StringUtils.isBlank(digestMethodAlgorithmWhiteList)) {
                    digestMethodAlgorithmWhiteList = String.join(EIDASValues.SEMICOLON.toString(), EidasSignatureConstants.DEFAULT_DIGEST_ALGORITHM_WHITE_LIST);
                }
                ...
                eidasMetadataParametersI.setHideLoaType(stringLoaType != null && stringLoaType.equals("true"));
