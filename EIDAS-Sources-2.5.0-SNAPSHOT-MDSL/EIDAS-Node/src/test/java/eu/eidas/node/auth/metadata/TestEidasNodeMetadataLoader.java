...
public class TestEidasNodeMetadataLoader {
    ...
    private static final String PROXY_SERVICE_ENTITTY_ID = "http://localhost:8080/EidasNode/ServiceMetadata";
    ...
    public void testValidateSignature() throws EIDASMetadataException {
        ...
        fetcher.getEidasMetadata(PROXY_SERVICE_ENTITTY_ID, metadataSigner, mockMetadataClockI);
    }
}
