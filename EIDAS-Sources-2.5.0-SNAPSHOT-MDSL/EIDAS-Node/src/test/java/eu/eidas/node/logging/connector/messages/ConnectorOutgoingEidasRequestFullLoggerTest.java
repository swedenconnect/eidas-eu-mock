 ...
 * @since 2.5
 */
public class ConnectorOutgoingEidasRequestFullLoggerTest {
    ...
    public void setup() {
        ...
        testedLogger = (Logger) ReflectionTestUtils.getField(connectorOutgoingEidasRequestLogger, "fullLogger");
    ...
    public void logFullMessageInvalidRequest () {
        ...
        ILoggingEvent actualLogEvent = logAppender.list.get(0);
        Level expectedErrorLevel = Level.ERROR;
        String expectedMessage = "Could not log the outgoing request because of ";
        Class expectedException = NullPointerException.class;
