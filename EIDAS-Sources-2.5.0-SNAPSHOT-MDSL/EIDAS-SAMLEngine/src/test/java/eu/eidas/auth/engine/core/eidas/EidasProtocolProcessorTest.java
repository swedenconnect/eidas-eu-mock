...
public class EidasProtocolProcessorTest {
    ...
    private static ProtocolEngineI protocolEngineMetdataFectherThrowsException
            = ProtocolEngineFactory.getDefaultProtocolEngine("ServiceMetdataFectherThrowsException");
     ...
     */
    @Test
    public void marshallRequestWithMetdataFectherThrowsException() throws EIDASSAMLEngineException {
...
//                .levelOfAssurance(nonNotifiedLoA)
    ...
    private AuthnRequest buildAuthnRequestWithMetdataFectherThrowsException(IEidasAuthenticationRequest eidasAuthnRequest) throws EIDASSAMLEngineException {
        ProtocolProcessorI eidasProtocolProcessor = protocolEngineMetdataFectherThrowsException.getProtocolProcessor();
        return eidasProtocolProcessor.marshallRequest(eidasAuthnRequest, PROXY_SERVICE,
                defaultCoreProperties, currentTime);
    }
    ...
    private AuthnRequest buildAuthnRequestMetadataFetcherThrowsException() throws EIDASSAMLEngineException {
        ...
        return buildAuthnRequestWithMetdataFectherThrowsException(iEidasAuthenticationRequest);
    }
