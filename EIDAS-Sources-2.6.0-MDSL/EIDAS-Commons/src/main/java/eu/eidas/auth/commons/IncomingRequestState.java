...
final class IncomingRequestState implements RequestState {
    ...
    public String getLevelOfAssurance() {
        if (getState().levelsOfAssurance != null && !getState().levelsOfAssurance.isEmpty()) {
            return getState().levelsOfAssurance.get(0);
        }
        return null;
    }
    ...
    public String getQaa() {
        throw new UnsupportedOperationException("QAA is not supported");
    }
