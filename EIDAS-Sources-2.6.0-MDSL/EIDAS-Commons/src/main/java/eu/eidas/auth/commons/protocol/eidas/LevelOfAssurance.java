...
/**
 * @deprecated since 2.5 : introduction of Non Notified LevelOfAssurance
 * use {@link NotifiedLevelOfAssurance} for predefined eidas values low/substantial/high (notified)
 * use {@link eu.eidas.auth.commons.light.impl.LevelOfAssurance} to all kinds of LevelOfAssurance
 *
...
public enum LevelOfAssurance {
    ...
    @Nonnull
    public List<LevelOfAssurance> getHigherLevelsOfAssurance() {
        List<LevelOfAssurance> higherLevelsOfAssurance = new ArrayList<>();
