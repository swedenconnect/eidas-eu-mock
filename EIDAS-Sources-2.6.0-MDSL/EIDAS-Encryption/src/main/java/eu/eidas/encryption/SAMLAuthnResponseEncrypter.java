...
public final class SAMLAuthnResponseEncrypter {
    ...
    private KeyEncryptionParameters buildKeyTransportEncryptionParams(@Nonnull Credential credential, boolean isKeyInfoAsKeyValue) {
        ...
        if (credential instanceof LegacySha1DigestX509Credential) {
            rsaoaepParameters.setDigestMethod(SignatureConstants.ALGO_ID_DIGEST_SHA1);
        } else {
            rsaoaepParameters.setDigestMethod(SignatureConstants.ALGO_ID_DIGEST_SHA256);
        }
