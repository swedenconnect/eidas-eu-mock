...
public abstract class SAMLAuthnResponseDecrypterTest {
    ...
    protected static final String EC_NIST_KEY_SERIAL_NUMBER = "233513f0d0978a85b8bafedb92d2f5e739377a1a";
    ...
    private final String keyStorePassword = "local-demo";
    ...
    public static void tearDownClass() {
        if (Security.getProvider(BOUNCY_CASTLE_PROVIDER_NAME) != null) {
            LOGGER.info("Remove BC Security Provider in the JVM");
    ...
    protected Response createResponse(String responseFilePath) {
        try {
    ...
    public void decryptSamlResponse() throws DecryptionException {
        String samlResponseFilePath = getResponseXMLFilePath();
        ...
        Response response = createResponse(samlResponseFilePath);
        Response actualResponse = decrypter.decryptSAMLResponse(response, decrytpCredentialArray);
     ...
     * where the matching credential is known and passed from the test KeyStore
     */
    @Test
    public void decryptSamlResponseEncryptWithSingleCredentials() throws DecryptionException {
        ...
        Response actualResponse = decrypter.decryptSAMLResponse(createResponse(samlResponse), decryptCredential);
