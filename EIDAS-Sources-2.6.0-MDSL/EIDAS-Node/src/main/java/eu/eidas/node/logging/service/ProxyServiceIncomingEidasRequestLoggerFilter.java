...
public class ProxyServiceIncomingEidasRequestLoggerFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        servletRequest.setAttribute(NodeParameterNames.CONTACT_EMAIL.toString(), PropertiesUtil.getProperty(EidasParameterKeys.PROXYSERVICE_CONTACT_SUPPORT.toString()));
        try {
            ...
            getProxyServiceIncomingEidasRequestLoggerImpl().logFullMessage(httpServletRequest);
