...
public class ConnectorIncomingLightRequestLoggerFilterTest {
    ...
    private void setUpBeanProvider(ConnectorIncomingLightRequestLogger connectorIncomingLightRequestLogger) throws NoSuchFieldException, IllegalAccessException {
