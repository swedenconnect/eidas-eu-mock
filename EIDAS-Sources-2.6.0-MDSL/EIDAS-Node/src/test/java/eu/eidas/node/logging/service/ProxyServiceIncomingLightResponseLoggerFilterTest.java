...
public class ProxyServiceIncomingLightResponseLoggerFilterTest {
     ...
     */
    private static final Logger logger = (Logger) LoggerFactory.getLogger(ProxyServiceIncomingLightResponseLoggerFilter.class.getName());

    private HttpServletRequest mockHttpServletRequest;
    private HttpServletResponse mockHttpServletResponse;
    private FilterChain mockFilterChain;
    private ProxyServiceIncomingLightResponseLogger mockProxyServiceIncomingLightResponseLogger;
    private ProxyServiceIncomingLightResponseLoggerFilter proxyServiceIncomingLightResponseLoggerFilter;
    ...
    public void setup() throws NoSuchFieldException, IllegalAccessException {
        ...
        mockProxyServiceIncomingLightResponseLogger = mock(ProxyServiceIncomingLightResponseLogger.class);
        setUpBeanProvider(mockProxyServiceIncomingLightResponseLogger);

        proxyServiceIncomingLightResponseLoggerFilter = new ProxyServiceIncomingLightResponseLoggerFilter();
    }

    private void setUpBeanProvider(ProxyServiceIncomingLightResponseLogger proxyServiceIncomingLightResponseLogger) throws NoSuchFieldException, IllegalAccessException {
    ...
    /**
     * Test method for {@link ProxyServiceIncomingLightResponseLoggerFilter#doFilter(ServletRequest, ServletResponse, FilterChain)}.
    ...
    public void doFilter() throws IOException, ServletException {
        ...
        proxyServiceIncomingLightResponseLoggerFilter.doFilter(mockHttpServletRequest,mockHttpServletResponse, mockFilterChain);

        Logger messageLogger = getMessageLogger();
        InOrder orderVerifier = inOrder(mockProxyServiceIncomingLightResponseLogger, mockFilterChain);
        orderVerifier.verify(mockProxyServiceIncomingLightResponseLogger).logMessage(messageLogger, mockHttpServletRequest);
        orderVerifier.verify(mockFilterChain).doFilter(mockHttpServletRequest,mockHttpServletResponse);

        assertLogging("LightResponseIncomingLogger FILTER for", traceAppender);
    }
    ...
    public void doFilterServletException() throws IOException {
        ...
        try {
            Logger messageLogger = getMessageLogger();
            doNothing().when(mockProxyServiceIncomingLightResponseLogger).logMessage(messageLogger, mockHttpServletRequest);
