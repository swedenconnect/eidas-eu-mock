...
public class AbstractProtocolEncrypterTest {
     ...
     * Test method for
     * {@link AbstractProtocolEncrypter#encryptSamlResponse(Response, X509Certificate, boolean)}
     * when happy flow for old protocol version
     * <p>
     * Must succeed.
     */
    @Test
    public void testEncryptSamlResponseForOldProtocolVersion() throws EIDASSAMLEngineException, CertificateException {
        final Response authResponse = createMockResponse();
        X509Certificate signingCert = new LegacySha1DigestX509Certificate(getRSACertificate());
        Response encryptedResponse = encrypter.encryptSamlResponse(authResponse, signingCert, true);
