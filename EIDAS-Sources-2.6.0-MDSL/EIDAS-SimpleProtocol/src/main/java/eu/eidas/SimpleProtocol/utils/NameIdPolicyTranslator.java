...
public enum NameIdPolicyTranslator {
    ...
    EMAIL("emailAddress","urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"),

    X509_SUBJECT("X509SubjectName", "urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName"),

    WIN_DOMAIN_QUALIFIED("WindowsDomainQualifiedName", "urn:oasis:names:tc:SAML:1.1:nameid-format:WindowsDomainQualifiedName"),
