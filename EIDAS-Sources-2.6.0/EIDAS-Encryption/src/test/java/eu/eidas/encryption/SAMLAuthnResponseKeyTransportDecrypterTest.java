...
public class SAMLAuthnResponseKeyTransportDecrypterTest {
    ...
    /**
     * Tests for the {@link SAMLAuthnResponseDecrypter} with Key Transport credentials
     * with assertion.encrypt.with.key.value true
     *
     * All must succeed
     */
    public static class SAMLAuthnResponseKeyTransportDecrypterWithDEREncodedKeyValue
            extends KeyTransportDecrypterTestConfig {

        private static final String MOCK_RESPONSE_FILE_PATH = "src/test/resources/responses/saml_rsa_rsa-oaep_encrypted_response_DEREncodedKeyValue.xml";
    ...
    /**
     * Tests for the {@link SAMLAuthnResponseDecrypter} with Key Transport credentials
     * without an X509 Certificate or DEREncodedKeyValue Public key
     *
     * must fail.
     */
    public static class SAMLAuthnResponseKeyTransportDecrypterMissingPubKey
            extends KeyTransportDecrypterTestConfig {

        private static final String MOCK_RESPONSE_FILE_PATH = "src/test/resources/responses/INVALID_saml_rsa_rsa-oaep_encrypted_response_missing_pubkey.xml";
        ...
        public void decryptSamlResponse() throws DecryptionException {
            ...
            exception.expectMessage("No public key or certificate found in the SAML Response.");
            super.decryptSamlResponse();
        }
    ...
    /**
     * Tests for the {@link SAMLAuthnResponseDecrypter} with Key Transport credentials
     * where the EncryptedAssertion does not contain a KeyInfo Element
     *
     * must fail.
     */
    public static class SAMLAuthnResponseKeyTransportDecrypterMissingKeyInfo
            extends KeyTransportDecrypterTestConfig {

        private static final String MOCK_RESPONSE_FILE_PATH = "src/test/resources/responses/INVALID_saml_rsa_rsa-oaep_encrypted_response_missing_keyInfo.xml";
