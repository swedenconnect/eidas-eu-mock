...
public class ConnectorOutgoingEidasRequestLoggerFilterTest {
    ...
    private void setUpBeanProvider(ConnectorOutgoingEidasRequestLogger mockConnectorOutgoingEidasRequestLogger) throws NoSuchFieldException, IllegalAccessException {
