...
public class SecurityRequestFilterTest {
    ...
    public void setUp() throws Exception {
        ...
        final ApplicationContext mockApplicationContext = Mockito.mock(ApplicationContext.class);
        ...
        Mockito.when(mockConfigurationSecurityBean.getBypassValidation())
                .thenReturn(false);
        Mockito.when(mockConfigurationSecurityBean.getValidationMethod())
                .thenReturn(EIDASValues.DOMAIN.toString());
        ...
        Mockito.when(mockConfigurationSecurityBean.getSpMaxRequests())
                .thenReturn(3);
        Mockito.when(mockApplicationContext.getBean(eq(NodeBeanNames.SECURITY_CONFIG.toString())))
     ...
     * <p>
     * Must fail
     * and throw {@link SecurityEIDASException}
     */
    @Test
    public void doFilterDomainIsNull() throws ServletException, IOException {
        exception.expect(SecurityEIDASException.class);
