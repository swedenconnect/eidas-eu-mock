 ...
 * @since 2.5
 */
public class SpecificConnectorCommunicationLoggerServiceImpl extends AbstractSpecificCommunicationLoggingService {

    SpecificConnectorCommunicationLoggerServiceImpl(final String lightTokenRequestSecret, final String lightTokenRequestAlgorithm,
    ...
    protected String getRequestCacheName(){
        return SpecificCommunicationDefinitionBeanNames.SPECIFIC_NODE_CONNECTOR_CACHE.toString();
    }

    protected String getResponseCacheName(){
        return SpecificCommunicationDefinitionBeanNames.NODE_SPECIFIC_CONNECTOR_CACHE.toString();
    }
}
