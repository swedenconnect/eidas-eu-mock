...
public interface ILightRequest extends Serializable {
     ...
     *
     * @return the first requested Level of Assurance (LoA) value for the authentication to be performed.
     */
     ...
     *
     * @return the list of requested Levels of Assurance for the authentication to be performed.
     */
     ...
     *
     * @return country code of SP, can be {@code null}.
     */
    @Nullable
    String getSpCountryCode();

    /**
     * Returns the Requester Id (optional)
     *
     * @return Requester Id, can be {@code null}
     */
    @Nullable
