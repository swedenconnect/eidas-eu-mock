...
import static eu.eidas.node.ConnectorBeanNames.CONNECTOR_INCOMING_EIDAS_RESPONSE_LOGGER;
...
public class ConnectorIncomingEidasResponseLoggerFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        try {
            ...
            getConnectorIncomingEidasResponseLoggerImpl().logFullMessage(httpServletRequest);
