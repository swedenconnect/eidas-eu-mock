...
import static eu.eidas.node.ConnectorBeanNames.CONNECTOR_OUTGOING_LIGHT_RESPONSE_LOGGER;
...
public class ConnectorOutgoingLightResponseLoggerFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        try {
            ...
            getLightResponseOutgoingLoggerImpl().logFullMessage(httpServletRequest);
