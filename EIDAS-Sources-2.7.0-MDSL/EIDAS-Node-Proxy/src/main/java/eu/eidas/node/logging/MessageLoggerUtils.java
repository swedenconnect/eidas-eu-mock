...
import static eu.eidas.node.ProxyBeanNames.EIDAS_SERVICE_CONTROLLER;
import static eu.eidas.node.ProxyBeanNames.NODE_PROTOCOL_ENGINE_FACTORY;
import static eu.eidas.node.ProxyBeanNames.PROXYSERVICE_METADATA_FETCHER;
...
public final class MessageLoggerUtils {
    ...
    public final Collection<AttributeDefinition<?>> retrieveProxyServiceAttributes() {
        String beanName = EIDAS_SERVICE_CONTROLLER.toString();
        ServiceControllerService serviceControllerService = getBean(ServiceControllerService.class, beanName);
    ...
    public final String getIssuer(String requestId, HttpServletRequest httpServletRequest) {
        ...
        if (StringUtils.isBlank(issuer)) {
            ...
            final String beanName = ProxyBeanNames.EIDAS_SERVICE_CONTROLLER.toString();
