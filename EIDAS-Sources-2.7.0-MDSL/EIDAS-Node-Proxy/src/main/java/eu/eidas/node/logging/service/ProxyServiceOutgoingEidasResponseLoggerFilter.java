...
import static eu.eidas.node.ProxyBeanNames.PROXY_SERVICE_OUTGOING_SAML_RESPONSE_LOGGER;
...
@WebFilter(filterName = "ProxyServiceOutgoingEidasResponseLoggerFilter",
        servletNames = {"SpecificProxyServiceResponse", "SamlResponseFailureServlet"},
