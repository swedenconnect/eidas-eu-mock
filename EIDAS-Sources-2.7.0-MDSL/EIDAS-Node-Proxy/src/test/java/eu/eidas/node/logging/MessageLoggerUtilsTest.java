...
import static eu.eidas.node.ProxyBeanNames.SPECIFIC_PROXYSERVICE_DEPLOYED_JAR;
import static eu.eidas.node.NodeSpecificViewNames.MONOLITH_SPECIFIC_PROXYSERVICE_REQUEST;
...
public class MessageLoggerUtilsTest {
    ...
    public void getProxyServiceRedirectUrlTrue() {
        ...
        assertThat(actualRedirectUrl, is(MONOLITH_SPECIFIC_PROXYSERVICE_REQUEST.toString()));
    }
