...
public interface ProtocolEngineI {
    ...
    /**
     * @deprecated  as of release 2.6,
     * replaced by {@link #generateResponseMessage(IAuthenticationRequest, IAuthenticationResponse, String)}
     *
     */
    @Nonnull
    @Deprecated
    ...
    /**
     * This method is deprecated, use instead {@link ProtocolEngineI#generateResponseErrorMessage(IAuthenticationRequest, IAuthenticationResponse, String)}
     *
     ...
     * @throws EIDASSAMLEngineException the EIDAS SAML engine exception
     */
    @Nonnull
    @Deprecated
    IResponseMessage generateResponseErrorMessage(@Nonnull IAuthenticationRequest request,
