...
import member_country_specific.specific.proxyservice.exceptions.SpecificProxyServiceError;
import member_country_specific.specific.proxyservice.logging.LoggingMarkerMDC;
import member_country_specific.specific.proxyservice.utils.SessionHolder;
...
import static member_country_specific.specific.proxyservice.SpecificProxyServiceBeanNames.SECURITY_CONFIG;
import static member_country_specific.specific.proxyservice.SpecificProxyServiceApplicationContextProvider.getApplicationContext;

@WebFilter(urlPatterns = "/*",
        initParams = {@WebInitParam(name = "includedServlets", value = "IdpResponse")})
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (performDomainCheck) {
            ...
            if (domain == null) {
                ...
                throw new SpecificProxyServiceError(errorCode, errorMsg);
            }
