 ...
 * Sample generated : X-Content-Security-Policy:default-src 'none'; object-src 'self'; style-src 'self'; img-src 'self'; connect-src 'self';script-src 'self'; report-uri http://node:8080/NODE/cspReportHandler
