...
public class InvalidParameterEIDASServiceException extends EIDASServiceException {
     ...
     */
    public InvalidParameterEIDASServiceException(final String errorCode, final String errorMessage) {
     ...
     */
    public InvalidParameterEIDASServiceException(final String errorCode, final String errorMessage, final String additionalInformation) {
