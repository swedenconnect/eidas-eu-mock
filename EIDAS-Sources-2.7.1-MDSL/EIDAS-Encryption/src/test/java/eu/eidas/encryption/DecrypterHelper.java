...
public class DecrypterHelper {
    ...
    public static final String EC_KEY_SERIAL_NUMBER = "4cd836d017315376daf6eaeab44aa1950a7268bf";
    public static final String EC_NIST_KEY_SERIAL_NUMBER = "233513f0d0978a85b8bafedb92d2f5e739377a1a";
    public static final String RSA_KEY_SERIAL_NUMBER = "13f9b7951cac5c38a772801403dd87680a0ec2ef";
    ...
    public X509Credential getSpecificDecrypterCredentials() {
    ...
    public Response createMockResponse(String responseFilePath) {
        try {
