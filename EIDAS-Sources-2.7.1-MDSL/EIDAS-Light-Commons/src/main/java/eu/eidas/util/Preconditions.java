...
public final class Preconditions {
    ...
    public static String checkURISyntax(String reference, String referenceName) throws IllegalArgumentException {
        checkNotNull(reference, referenceName);
        try {
            URI uri = new URI(reference);
            if (!uri.isAbsolute()) throw new IllegalArgumentException(referenceName + " URI missing protocol prefix");
            return reference;
        } catch (URISyntaxException e) {
            throw new IllegalArgumentException(referenceName + " does not have a valid URI syntax");
        }
    }
