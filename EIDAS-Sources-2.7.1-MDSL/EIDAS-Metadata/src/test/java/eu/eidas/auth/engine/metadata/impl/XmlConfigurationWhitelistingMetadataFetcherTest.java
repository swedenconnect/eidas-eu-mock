...
public class XmlConfigurationWhitelistingMetadataFetcherTest {
    ...
    @Test
    public void testCheckWhitelistedSuccess() throws EIDASMetadataException {
        underTest_Whitelisting.checkWhitelisted("http://google.com/metadata");
    }

    @Test(expected = EIDASMetadataException.class)
    public void testCheckWhitelistedFail() throws EIDASMetadataException {
        underTest_Whitelisting.checkWhitelisted("http://disney.com/metadata");
        fail("Expecting EIDASMetadataException");
    }
