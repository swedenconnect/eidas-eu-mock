...
import static eu.eidas.node.ConnectorBeanNames.CONNECTOR_OUTGOING_EIDAS_REQUEST_LOGGER;
...
public class ConnectorOutgoingEidasRequestLoggerFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        try {
            ...
            getConnectorOutgoingEidasRequestLoggerImpl().logFullMessage(httpServletRequest);
