 ...
 *      Sample generated : X-Content-Security-Policy:default-src 'none'; object-src 'self'; style-src 'self'; img-src 'self'; connect-src 'self';script-src 'self'; report-to http://node:8080/EidasNodeConnector/cspReportHandler
...
public class SecurityResponseHeaderHelper {
    ...
    /* Add CSP policies to HTTP response */
        final StringBuilder policiesBuilder = new StringBuilder(this.policies);
