...
public class ConnectorIncomingEidasResponseLoggerFilterTest {
    ...
    public void doFilter() throws IOException, ServletException {
        ...
        orderVerifier.verify(mockConnectorIncomingEidasResponseLogger).logFullMessage(mockHttpServletRequest);
    ...
    public void doFilterServletException() throws IOException {
        ...
        try {
            Logger messageLogger = getMessageLogger();
            doNothing().when(mockConnectorIncomingEidasResponseLogger).logFullMessage(mockHttpServletRequest);
