...
import static eu.eidas.node.ProxyBeanNames.PROXY_SERVICE_OUTGOING_LIGHT_REQUEST_LOGGER;
...
public class ProxyServiceOutgoingLightRequestLoggerFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        try {
            ...
            getLightRequestOutgoingLoggerImpl().logFullMessage(httpServletRequest);
