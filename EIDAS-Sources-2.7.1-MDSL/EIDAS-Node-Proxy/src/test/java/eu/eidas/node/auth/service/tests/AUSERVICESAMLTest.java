...
public class AUSERVICESAMLTest {
     ...
     * {@since 2.7.0} Nodes with specification version 1.1 are no longer supported
     * <p>
     * Must fail
    ...
    public void processConnectorRequestFromPrivateSectorMissingRequesterIdButSpecs1_1() throws Exception {
        ...
        IAuthenticationRequest mockIAuthenticationRequest = getTestAuthenticationRequestBuilder()
                ...
                .build();
        mockProtocolEngineFactoryWith(mockIAuthenticationRequest);
        Mockito.lenient().when(mockAuServiceUtil.getProperty(EIDASValues.REQUESTER_ID_FLAG.toString())).thenReturn("true");
    ...
    /**
     * Test method for {@link AUSERVICESAML#processConnectorRequest(String, byte[], String, String)}.
     * When saml request is send from a Spec 1.1 connector
     * <p>
     * Must fail
     * @deprecated since 2.7
     */
