...
public class ProxyServiceIncomingEidasRequestLoggerFilterTest {
    ...
    private void setUpBeanProvider(ProxyServiceIncomingEidasRequestLogger proxyServiceIncomingEidasRequestLogger) throws NoSuchFieldException, IllegalAccessException {
    ...
    public void doFilter() throws IOException, ServletException {
        ...
        orderVerifier.verify(mockProxyServiceIncomingEidasRequestLogger).logFullMessage(mockHttpServletRequest);
    ...
    public void doFilterServletException() throws IOException {
        ...
        try {
            Logger messageLogger = getMessageLogger();
            doNothing().when(mockProxyServiceIncomingEidasRequestLogger).logFullMessage(mockHttpServletRequest);
