...
public class ProxyServiceErrorServletTest {
    ...
    public void testPopulateResponseHeader() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        final Method populateResponseHeader = ProxyServiceErrorServlet.class.getDeclaredMethod("populateResponseHeader",
                HttpServletRequest.class, HttpServletResponse.class, SecurityResponseHeaderHelper.class);
        ...
        populateResponseHeader.invoke(proxyServiceErrorServlet, mockHttpServletRequest, extendedServletResponseWrapper, mockSecurityResponseHeaderHelper);
    }
    ...
    private void mockConfigurationSecurityBean() {
        ...
        Mockito.when(mockApplicationContext.getBean(ProxyBeanNames.SECURITY_CONFIG.toString())).thenReturn(mockConfigurationSecurityBean);
    }
