...
public final class KeyStoreEncryptionConfigurator {
    ...
    private static List<KeyStoreContent> fetchLegacyConfiguration(Map<String, String> properties, String defaultPath) throws ProtocolEngineConfigurationException {
        ...
        if (properties.containsKey(KeyStoreConfigurator.DEFAULT_KEYSTORE_CONFIGURATION_KEYS.getKeyStoreTypeConfigurationKey())) {
            legacyKeyStores.add(new KeyStoreConfigurator(properties, defaultPath).loadKeyStoreContent());
        }
