...
public interface ProtocolSignerI {
     ...
     * @deprecated Should use {@link ProtocolSignerI#sign(SignableXMLObject, SigningContext)} instead.
     */
    @Deprecated
    @Nonnull
     ...
     *
     * @param signableObject the SAML object to sign (an Assertion, a Request or a Response).
     * @param signContext Context information usefull to create a signature such as Credential, algorithm and KeyInfo format.
     * @param <T> the type of the XML object to sign
     * @return the signed SAML object (an Assertion, a Request or a Response)
     * @throws EIDASSAMLEngineException in case of signature errors
     */
    @Nonnull
    <T extends SignableXMLObject> T sign(@Nonnull T signableObject, SigningContext signContext) throws EIDASSAMLEngineException;
    ...
    /**
     * Returns the signature configuration for the ProtocolSigner
     * @return the SignatureConfiguration
     * @since 2.6
     */
    ...
    @Nonnull
    Collection<String> getTrustedCredentialGraphIdentifiers();
}
