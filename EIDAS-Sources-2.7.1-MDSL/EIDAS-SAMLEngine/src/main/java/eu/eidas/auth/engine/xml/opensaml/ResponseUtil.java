...
public final class ResponseUtil {
    ...
    public static void verifyAudienceRestriction(@Nonnull Conditions conditions, @Nonnull final String audienceRestriction)
        ...
        for (final Audience audience : audiences) {
            if (audience.getURI().equals(audienceRestriction)) {
    ...
    public static void verifyTimeConditions(@Nonnull Conditions conditions, @Nonnull DateTime now)
        ...
        DateTime notBefore = conditions.getNotBefore() != null ? new DateTime(conditions.getNotBefore().toEpochMilli()) : null;
        if (notBefore == null) {
        ...
        DateTime notOnOrAfter = conditions.getNotOnOrAfter() != null ? new DateTime(conditions.getNotOnOrAfter().toEpochMilli()) : null;
