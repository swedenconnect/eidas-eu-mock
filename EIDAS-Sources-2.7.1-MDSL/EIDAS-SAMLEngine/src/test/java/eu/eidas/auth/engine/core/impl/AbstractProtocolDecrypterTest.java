...
public class AbstractProtocolDecrypterTest {
    ...
    private AbstractProtocolDecrypter generateAbstractProtocolDecrypter(String keystoreFileLocation, Boolean checkedValidityPeriod) {
        ...
        return new AbstractSamlEngineEncryption.BaseProtocolDecrypter(
                checkedValidityPeriod,
                false,
                true,
                true,
                decryptionKeyAndCertificates,
                dummySAMLAuthnResponseDecrypter,
