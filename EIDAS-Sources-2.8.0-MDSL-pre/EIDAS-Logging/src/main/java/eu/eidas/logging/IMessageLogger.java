...
public interface IMessageLogger {
     ...
     * @param httpServletRequest the http servlet request that contains the {@link BinaryLightToken} or the SamlToken Base64 encoded.
     * @deprecated
     * use {@link #logMessage(HttpServletRequest)} instead
     * Responsibility of specifying the {@link Logger} has shifted from the Filter to IMessageLogger loggers
     */
    @Deprecated
     void logMessage(final Logger logger, final HttpServletRequest httpServletRequest);
