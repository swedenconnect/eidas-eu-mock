...
package eu.eidas.logging.integrity;
...
public final class HashAndCounterGenerator {
     ...
     */
    public HashAndCounterGenerator(final boolean isCounterUsed, final String hashAlgorithm, ByteArrayOutputStream outputStream) {
        ...
        try {
            ...
            throw new InvalidParameterEIDASException(EidasErrorKey.INTERNAL_ERROR.errorCode(),
                    "Invalid hashAlgorithm " + hashAlgorithm, exception);
        }
    }
