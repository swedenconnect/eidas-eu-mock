...
public class IncomingLoggerFilterTest {
    ...
    private void setUpBeanProvider(IFullMessageLogger connectorIncomingEidasResponseLogger, String beanName) throws NoSuchFieldException, IllegalAccessException {
        ApplicationContext mockApplicationContext = mock(ApplicationContext.class);
        Mockito.when(mockApplicationContext.getBean(beanName)).thenReturn(connectorIncomingEidasResponseLogger);
