...
public class OutgoingLoggerFilterTest {
    ...
    public void setup() throws NoSuchFieldException, IllegalAccessException {
        ...
        setUpBeanProvider(iFullMessageLogger, fullMessageLoggerBeanAlias);
    ...
    private void setUpBeanProvider(IFullMessageLogger iFullMessageLogger, String fullMessageLoggerBeanAlias) throws NoSuchFieldException, IllegalAccessException {
        ApplicationContext mockApplicationContext = mock(ApplicationContext.class);
        Mockito.when(mockApplicationContext.getBean(fullMessageLoggerBeanAlias)).thenReturn(iFullMessageLogger);
