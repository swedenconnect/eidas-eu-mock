...
public final class MetadataSignatureHelper extends AbstractMetadataHelper {
    ...
    /**
     * @deprecated use {@link EidasMetadataRoleParametersI#getSigningCertificate()}
     */
    @Deprecated
    ...
    /**
     * @deprecated Request signature (from connector/SP metadata, validated in the proxy use {@link HighLevelMetadataParamsI#getRequestSignatureCertificate()} or
     * <p>
     * Response signature (from proxy/IDP metadata, validated in the connector use {@link HighLevelMetadataParamsI#getResponseSignatureCertificate()}
     */
    @Deprecated
    @Nullable
    ...
    /**
     * @deprecated use {@link HighLevelMetadataParamsI#getRequestSignatureCertificate()}
     */
    @Deprecated
    @Nullable
    ...
    /**
     * @deprecated use {@link HighLevelMetadataParamsI#getResponseSignatureCertificate()}
     */
    @Deprecated
    @Nullable
