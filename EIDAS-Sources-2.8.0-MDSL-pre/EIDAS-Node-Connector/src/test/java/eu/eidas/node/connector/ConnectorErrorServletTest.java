...
public class ConnectorErrorServletTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(contextRefreshedEvent.getApplicationContext()).thenReturn(mockApplicationContext);
        new eu.eidas.security.BeanProvider().onApplicationEvent(contextRefreshedEvent);
