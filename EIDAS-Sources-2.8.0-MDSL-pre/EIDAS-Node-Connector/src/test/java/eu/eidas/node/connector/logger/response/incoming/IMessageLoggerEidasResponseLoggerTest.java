...
public class IMessageLoggerEidasResponseLoggerTest {
    ...
    private final Logger logger = (Logger) LoggerFactory.getLogger(IMessageLogger.getLoggerName(
            EIDASValues.EIDAS_PACKAGE_RESPONSE_LOGGER_VALUE, ConnectorIncomingEidasResponseLogger.class));
    ...
    public void setup() {
        ...
        eidasResponseLogger = new ConnectorIncomingEidasResponseLogger();
    }
    ...
    public void testLogOfInvalidEidasResponse() throws EIDASSAMLEngineException {
        ...
        eidasResponseLogger.logMessage(logger, mockHttpServletRequest);
        ...
        List<String> expectedStrings = Arrays.asList(
                "Timestamp",
                "OpType", EIDASValues.EIDAS_CONNECTOR_RESPONSE.toString(),
                "NodeId", LoggingConstants.UNDEFINED,
                "Origin", CONNECTOR_INCOMING_RESPONSE_ORIGIN,
                "Destination", CONNECTOR_INCOMING_RESPONSE_DESTINATION,
