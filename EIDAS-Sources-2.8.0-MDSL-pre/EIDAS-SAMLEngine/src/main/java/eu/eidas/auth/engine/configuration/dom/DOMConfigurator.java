...
public final class DOMConfigurator {
    ...
    private static <T> T createReloadableProxyIfNeeded(@Nonnull String instanceName,
        ...
        ImmutableMap<String, String> defaultParameters = getDefaultSamlProperties();
    ...
    private static ImmutableMap<String, String> getDefaultSamlProperties() {
        ...
        return ImmutableMap.copyOf(defaultPropertiesMap);
    }
