...
public final class KeyStoreConfigurator {
    ...
    public static KeyStoreContent getKeyStoreContent(KeyStore keyStore, char[] password, String purpose)
            throws ProtocolEngineConfigurationException {
        try {
            ImmutableSet.Builder<KeyContainerEntry> keyContainerEntries = ImmutableSet.builder();
            ImmutableSet.Builder<X509Certificate> certificates = ImmutableSet.builder();
            ...
            ImmutableSet<KeyContainerEntry> entries = keyContainerEntries.build();
            ...
            return new KeyStoreContent(entries, certificates.build(), purpose);
