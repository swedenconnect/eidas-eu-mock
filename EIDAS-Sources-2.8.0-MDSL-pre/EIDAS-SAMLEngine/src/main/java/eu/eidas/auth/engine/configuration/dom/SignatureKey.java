...
public enum SignatureKey {
    ...
    METADATA_SIGNATURE_ALGORITHM("metadata.signature.algorithm"),

    SIGNATURE_ALGORITHM_WHITE_LIST("signature.algorithm.whitelist"),

    DIGEST_METHOD_ALGORITHM("digest.method.algorithm"),
    DIGEST_METHOD_ALGORITHM_WHITELIST("digest.method.algorithm.whitelist"),
    ...
    ENABLE_CERTIFICATE_REVOCATION_CHECKING("enable.certificate.revocation.checking"),
    ENABLE_CERTIFICATE_REVOCATION_SOFT_FAIL("enable.certificate.revocation.soft.fail"),
