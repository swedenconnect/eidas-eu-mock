...
public interface ProtocolProcessorI {
     ...
     * @throws EIDASSAMLEngineException the EIDASSAML engine exception
     *
     * @deprecated use {@link HighLevelMetadataParamsI#getEncryptionCertificate()} from {@link #getMetadataParameters(String)} instead
     */
    @Deprecated
    @Nullable
     ...
     *
     * @deprecated use {@link HighLevelMetadataParamsI#getRequestSignatureCertificate()} from {@link #getMetadataParameters(String)} instead
     */
    @Deprecated
    @Nullable
     ...
     * @throws EIDASSAMLEngineException in case of errors
     *
     * @deprecated use {@link HighLevelMetadataParamsI#getResponseSignatureCertificate()} from {@link #getMetadataParameters(String)} instead
     */
    @Deprecated
    @Nullable
     ...
     * <p>
     * The returned instance is complete and ready to be marshalled by {@link #marshallRequest(IEidasAuthenticationRequest, String, SamlEngineCoreProperties, DateTime)}
     * <p>
