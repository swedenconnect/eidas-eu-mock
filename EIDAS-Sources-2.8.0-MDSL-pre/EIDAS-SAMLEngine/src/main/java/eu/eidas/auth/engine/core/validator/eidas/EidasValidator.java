...
public interface EidasValidator {
    ...
    /**
     * Throws a {@link ValidationException} based on the {@literal toValidate} , if the given value is not null , no
    ...
    /**
     * Throws a {@link ValidationException} based on the {@literal resultOK} boolean value, if the result is ok (true), no
