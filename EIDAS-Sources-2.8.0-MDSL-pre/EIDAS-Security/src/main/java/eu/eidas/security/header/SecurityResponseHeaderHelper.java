...
public class SecurityResponseHeaderHelper {
    ...
    public static final String X_CONTENT_SECURITY_POLICY_HEADER    = "X-Content-Security-Policy";
    public static final String X_WEB_KIT_CSP_HEADER                = "X-WebKit-CSP";
    ...
    public SecurityResponseHeaderHelper() {
        ...
        this.configurationSecurityBean = BeanProvider.getBean(ConfigurationSecurityBean.class);
    ...
    public void populateResponseHeader(HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException {
        ...
        if (httpResponse instanceof ExtendedServletResponseWrapper) {
            ((ExtendedServletResponseWrapper) httpResponse).setCSPHeaders(true);
        }
    }
}
