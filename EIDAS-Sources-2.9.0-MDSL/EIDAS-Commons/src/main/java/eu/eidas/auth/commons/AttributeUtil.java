...
public final class AttributeUtil {
     ...
     */
    public static SortedSet<AttributeDefinition<?>> clone(SortedSet<AttributeDefinition<?>> attributes) {
     ...
     *
     * @param src the instance of {@link SortedSet} that holds one of the set of {@link AttributeDefinition} to be compared
     * @param trgt the instance of {@link SortedSet} that holds the other set of {@link AttributeDefinition} to be compared
     * @return true if equals
     */
    public static boolean areDefinitionsEqual(SortedSet<AttributeDefinition<?>> src, SortedSet<AttributeDefinition<?>> trgt) {
        boolean ret = false;
