...
public final class EidasParameters {
    ...
    /**
     * param's size suffix to get max param size.
     */
    ...
    private static Map<String, String> loadProperties() {
        ...
        try (InputStream inputStream = EidasParameters.class.getClassLoader().getResourceAsStream(PROPERTIES_FILENAME)) {
    ...
    public static int getMaxSizeFor(EidasParameterKeys paramKey) {
        String paramConf = MAX_PARAM_PREFIX + paramKey.toString() + MAX_PARAM_SUFFIX;
        return Integer.parseInt(get(paramConf));
    }
}