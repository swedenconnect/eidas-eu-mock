...
public class AttributeValidatorTest {
    ...
    /**
     * Test for attribute validator for a valid {@link EidasSpec.Definitions#GENDER}
     * attribute value based on enum of {@link Gender}, delegated to genderValidator.
     *
     * Must succeed
     */
    @Test
    public void testAttributeValidatorOnEidasGender() {
        AttributeValue attrValue = Mockito.mock(AttributeValue.class);
        Mockito.when(attrValue.getValue()).thenReturn(Gender.FEMALE);

        AttributeValidator validator = AttributeValidator.of(EidasSpec.Definitions.GENDER);
        validator.validate(attrValue);

        verifyValidatorType(GenderValidator.class, validator);
    }

    /**
     * Test for attribute validator for a valid {@link NaturalPersonSpec.Definitions#GENDER}
     * attribute value based on enum of {@link Gender}, delegated to genderValidator.
     *
     * Must succeed
     */
    @Test
    public void testAttributeValidatorOnGender() {
        AttributeValue attrValue = Mockito.mock(AttributeValue.class);
        Mockito.when(attrValue.getValue()).thenReturn(Gender.FEMALE);

        AttributeValidator validator = AttributeValidator.of(NaturalPersonSpec.Definitions.GENDER);
        validator.validate(attrValue);
    ...
    /**
     * Test for attribute validator for a valid {@link RepresentativeNaturalPersonSpec.Definitions#GENDER}
     * attribute value based on enum of {@link Gender}, delegated to genderValidator.
     *
     * Must succeed
     */
    @Test
    public void testAttributeValidatorOnRepresentativeGender() {
        AttributeValue attrValue = Mockito.mock(AttributeValue.class);
        Mockito.when(attrValue.getValue()).thenReturn(Gender.MALE);

        AttributeValidator validator = AttributeValidator.of(RepresentativeNaturalPersonSpec.Definitions.GENDER);
        validator.validate(attrValue);
