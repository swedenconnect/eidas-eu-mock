...
public class SingleBeanTestCase {
    ...
    public void testEidasNodeError() {
        ...
        Assert.assertEquals(EidasErrorKey.MISSING_SESSION_ID.errorMessage(),
                EidasErrorKey.MISSING_SESSION_ID.toString() + EidasErrorKey.MESSAGE_CONSTANT);
        ...
        Assert.assertEquals(EidasErrorKey.MISSING_SESSION_ID.errorCode(),
                EidasErrorKey.MISSING_SESSION_ID.toString() + EidasErrorKey.CODE_CONSTANT);
    }
