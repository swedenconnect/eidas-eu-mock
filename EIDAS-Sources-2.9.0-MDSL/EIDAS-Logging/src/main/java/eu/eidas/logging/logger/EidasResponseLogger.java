    ...
    public final void logMessage(final HttpServletRequest httpServletRequest) {
        if (messageLoggerUtils.isLogMessages()) {
            ...
            try {
                ...
                commsLogger.error(LoggingMarkerMDC.SAML_EXCHANGE, "Incomplete log of the eIDAS SAML response because of ", e);
    ...
    public void logFullMessage(HttpServletRequest httpServletRequest) {
        if (messageLoggerUtils.isLogCompleteMessage()) {
            try {
                ...
                final String samlResponse = characterEncoding != null ? new String(msgObj, characterEncoding) : new String(msgObj, StandardCharsets.UTF_8);
