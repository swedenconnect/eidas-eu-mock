...
public interface MetadataFetcherI {
    ...
    /**
     * Returns the metadata EntityDescriptor instance fetched from the given Issuer.
     *
     * @param metadataIssuer the issuer of the Saml request / response
     * @param requiredMsgSigningCertKeyInfo the certificate that signs the request / response
     ...
     */
    @Nonnull
    EidasMetadataParametersI getEidasMetadata(
            @Nonnull Issuer metadataIssuer,
            KeyInfo requiredMsgSigningCertKeyInfo,
     ...
     */
    @Nonnull
    EidasMetadataParametersI getEidasMetadata(@Nonnull String metadataUrl, @Nonnull MetadataSignerI metadataSigner, MetadataClockI metadataClock)
            throws EIDASMetadataException;
}
