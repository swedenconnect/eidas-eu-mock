...
public class ProtocolEngineFactory {
    ...
    public static ProtocolEngineI createProtocolEngine(@Nonnull String instanceName,
        ...
        protocolProcessor.configure(null);
    ...
    private final Map<String, ProtocolEngineI> engines;
    ...
    public ProtocolEngineFactory(@Nonnull SingletonAccessor<Map<String, ProtocolEngineConfiguration>> accessor)
            throws ProtocolEngineConfigurationException {
        Preconditions.checkNotNull(accessor, "accessor");
        this.accessor = accessor;
        Map<String, ProtocolEngineI> engineMap = new LinkedHashMap<>();
        try {
            Map<String, ProtocolEngineConfiguration> configurationMap = accessor.get();
            for (final String instanceName : configurationMap.keySet()) {
                engineMap.put(instanceName, createProtocolEngine(instanceName));
            }
        } catch (IOException e) {
        ...
        engines = Collections.unmodifiableMap(engineMap);
    }
        ...
        return createProtocolEngine(new ProtocolConfigurationAccessor() {
            ...
            public ProtocolEngineConfiguration get() throws ProtocolEngineConfigurationException {
                try {
                    ...
                    throw new ProtocolEngineConfigurationException(EidasErrorKey.SAML_ENGINE_CONFIGURATION_ERROR,
                            "Failed to read the engine configuration", e);
                }
            }
        });
    }
