...
public final class DOMConfigurationParser {
    ...
    public static InstanceMap parseConfiguration(@Nonnull String configurationFileName)
        ...
        try {
            ...
            if (null == resource) {
                ...
                LOG.error(message);
                throw new ProtocolEngineConfigurationException(EidasErrorKey.SAML_ENGINE_CONFIGURATION_ERROR, message);
            } else {
    ...
    public static InstanceMap parseConfiguration(@Nonnull String configurationFileName,
        ...
        try {
            ...
            return new InstanceMap(Collections.unmodifiableMap(instanceEntries));
        } catch (IOException | SAXException | ParserConfigurationException ex) {
            LOG.error(ex.getMessage(), ex);
            throw new ProtocolEngineConfigurationException(EidasErrorKey.SAML_ENGINE_CONFIGURATION_ERROR, "", ex);
        }
    }
    ...
    private static InstanceEntry parseInstanceEntry(@Nonnull String configurationFileName, @Nonnull Element instanceTag)
        ...
        return new InstanceEntry(instanceName, Map.copyOf(configurationEntries));
    }
     ...
     */
    @Nonnull
    private static Map<String, String> parseParameters(@Nonnull String configurationFileName,
                                                                @Nonnull String instanceName,
    ...
    @Nonnull
    static Map<String, String> validateParameters(@Nonnull String instanceName,
                                                           @Nonnull String configurationName,
