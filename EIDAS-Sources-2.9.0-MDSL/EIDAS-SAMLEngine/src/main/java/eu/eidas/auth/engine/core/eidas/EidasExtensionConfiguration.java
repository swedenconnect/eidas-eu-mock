...
public final class EidasExtensionConfiguration {
     ...
     * @param protocolSigner the protocolSigner used in the current configuration
     */
    public static void configureExtension(@Nonnull ProtocolProcessorI protocolProcessor,
        ...
        XMLObjectProviderRegistrySupport.registerObjectProvider(Signature.DEFAULT_ELEMENT_NAME,
                new org.opensaml.xmlsec.signature.impl.SignatureBuilder(),
                new eu.eidas.auth.engine.core.eidas.impl.SignatureMarshaller(protocolSigner),
                new eu.eidas.auth.engine.core.eidas.impl.SignatureUnmarshaller());
        ...
        SortedSet<AttributeDefinition<?>> attributeDefinitions = protocolProcessor.getAllSupportedAttributes();
