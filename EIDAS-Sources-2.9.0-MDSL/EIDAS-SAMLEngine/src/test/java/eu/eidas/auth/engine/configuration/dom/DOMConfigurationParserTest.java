...
public class DOMConfigurationParserTest {
    ...
    public void testValidateParametersAllOK() throws ProtocolEngineConfigurationException {
        ...
        Map<String, String> immutableMap = DOMConfigurationParser.validateParameters("dummyInstanceName", "dummyConfigurationName", values);
    ...
    public void testValidateParametersExceptionWhenParameterNameBlank() throws ProtocolEngineConfigurationException {
        ...
        expectedException.expectMessage("SAML engine configuration file contains a blank parameter name for configuration name \"dummyConfigurationName\" in instance name \"dummyInstanceName\"");
    ...
    public void testValidateParametersExceptionWhenParameterValueBlank() throws ProtocolEngineConfigurationException {
        expectedException.expect(ProtocolEngineConfigurationException.class);
        expectedException.expectMessage("SAML engine configuration file contains parameter name \"consentAuthnRequest\" with a blank value for configuration name \"dummyConfigurationName\" in instance name \"dummyInstanceName\"");
