...
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.CURRENT_FAMILY_NAME;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.CURRENT_GIVEN_NAME;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.DATE_OF_BIRTH;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.LEGAL_NAME;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.LEGAL_PERSON_IDENTIFIER;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.PLACE_OF_BIRTH;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.REPV_CURRENT_FAMILY_NAME;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.REPV_CURRENT_GIVEN_NAME;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.REPV_DATE_OF_BIRTH;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.REPV_LEGAL_NAME;
...
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.REPV_PLACE_OF_BIRTH;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.REPV_VAT_REGISTRATION_NUMBER;
import static eu.eidas.auth.commons.protocol.eidas.spec.EidasSpec.Definitions.VAT_REGISTRATION_NUMBER;
...
public class EidasProtocolProcessorTest {
    ...
    private final ZonedDateTime currentTime = ZonedDateTime.now(ZoneOffset.UTC);
    ...
    private final EidasMetadataParametersI mockEidasMetadataParameters = Mockito.mock(EidasMetadataParametersI.class);
    ...
    public void setUp() throws EIDASMetadataException {
        ...
        Mockito.when(metadataFetcher.getEidasMetadata(any(), any(), eq(metadataSigner), eq(metadataClock)))
    ...
    public void testGetCountryCodeFromRequestSignatureCertificate() throws Exception {
        ...
        expectedException.expectMessage("Country code was not present in colleague metadata");
    ...
    public void testGetCountryCodeFromMetadataSignatureCertificateWhenRequest() throws Exception {
        ...
        AuthnRequest samlRequest = Mockito.mock(AuthnRequest.class, RETURNS_DEEP_STUBS);
        Mockito.when(samlRequest.getIssuer().getValue()).thenReturn(metadataUrl);
        Mockito.when(samlRequest.getSignature().getKeyInfo().getX509Datas().get(0).getX509Certificates().get(0).getValue())
                .thenReturn(null);
        ...
        Mockito.when(mockSPRoleDescriptor.getSigningCertificates()).thenReturn(List.of(mockSignatureCertificate));
    ...
    public void testGetCountryCodeFromMetadataSignatureCertificateWhenResponse() throws Exception {
        ...
        Mockito.when(mockIDPRoleDescriptor.getSigningCertificates()).thenReturn(List.of(mockSignatureCertificate));
    ...
    /**
     * Test method for  {@link HighLevelMetadataParams#getMetadataProtocolVersions()}
     * when the metadata are having eidas protocol versions
     * <p>
     * Must succeed
     */
    @Test
    public void testGetMetadataProtocolVersions() throws EIDASMetadataException, EIDASSAMLEngineException {
        String metadataUrl = "testUrl";
        List<String> protocolVersionsList = Arrays.asList("1.3", "1.2");
        Mockito.when(mockEidasMetadataParameters.getEidasProtocolVersions()).thenReturn(protocolVersionsList);

        List<EidasProtocolVersion> actualProtocolVersions = protocolProcessor.getMetadataParameters(metadataUrl).getMetadataProtocolVersions();

        List<EidasProtocolVersion> expectedProtocolVersions = Arrays.asList(EidasProtocolVersion.PROTOCOL_VERSION_1_3, EidasProtocolVersion.PROTOCOL_VERSION_1_2);
     ...
     */
    @Test
    public void testGetMetadataProtocolVersionsEmpty() throws EIDASMetadataException, EIDASSAMLEngineException {
        String metadataUrl = "testUrl";
        Mockito.when(mockEidasMetadataParameters.getEidasProtocolVersions()).thenReturn(null);

        List<EidasProtocolVersion> actualProtocolVersions = protocolProcessor.getMetadataParameters(metadataUrl)
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#marshallRequest(IEidasAuthenticationRequest, String, SamlEngineCoreProperties, ZonedDateTime)}
    ...
    public void marshallRequestWithMetadataFetcherThrowsException() throws EIDASSAMLEngineException {
        expectedException.expect(EIDASSAMLEngineException.class);
        expectedException.expectMessage("samlengine.metadata.retrieval.error.message");
        expectedException.expectCause(allOf(
                isA(EIDASMetadataException.class),
                hasProperty("message", containsString("demo exception"))
        ));
    ...
    public void testValidateRequestAgainstMetadataExceptionBuildingUpdatedRequest() throws NoSuchMethodException, EIDASMetadataException, InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        final TreeSet<String> supportedAttributesSet = new TreeSet<>(mockSupportedAttributes);
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#marshallResponse(IAuthenticationRequest, IAuthenticationResponse, String, SamlEngineCoreProperties, ZonedDateTime)}
    ...
    public void testIsAcceptableHttpRequestMismatchedAssertionConsumerServiceURL() throws EIDASSAMLEngineException, NoSuchFieldException, IllegalAccessException, EIDASMetadataException {
        ...
        IAuthenticationRequest mockRequest = Mockito.mock(IAuthenticationRequest.class);
        EidasMetadataParametersI mockEidasMetadataParameters = Mockito.mock(EidasMetadataParametersI.class);
        Mockito.when(mockMetadataFetcher.getEidasMetadata(any(), any(), any(), any())).thenReturn(mockEidasMetadataParameters);
        EidasMetadataRoleParametersI mockRoleParameters = Mockito.mock(EidasMetadataRoleParametersI.class);
        Mockito.when(mockEidasMetadataParameters.getRoleDescriptors()).thenReturn(Collections.singleton(mockRoleParameters));
    ...
    public void testIsAcceptableHttpRequestExceptionInMetadataFetcher() throws EIDASSAMLEngineException, NoSuchFieldException, IllegalAccessException, EIDASMetadataException {
        ...
        Mockito.when(mockMetadataFetcher.getEidasMetadata(any(), any(), any(), any())).thenThrow(EIDASMetadataException.class);
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for natural person are present
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_NaturalPerson_AllAttributesPresent() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(PERSON_IDENTIFIER,setAttributeDefinitionStringValue(PERSON_IDENTIFIER, "BE/CA/54321"))
                .put(CURRENT_FAMILY_NAME, setAttributeDefinitionStringValue(CURRENT_FAMILY_NAME, "Johnson"))
                .put(CURRENT_GIVEN_NAME, setAttributeDefinitionStringValue(CURRENT_GIVEN_NAME, "Long"))
                .put(DATE_OF_BIRTH, setAttributeDefinitionDateValue(DATE_OF_BIRTH,"2022-02-02"))
                .put(PLACE_OF_BIRTH,setAttributeDefinitionStringValue(PLACE_OF_BIRTH,"nowhere"))
                .build();

        Assert.assertTrue(protocolProcessor.checkMandatoryAttributes(attributeMap));
    }

    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when MDS attributes are missing for natural person
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_NaturalPerson_Missing_Attributes() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(PERSON_IDENTIFIER,setAttributeDefinitionStringValue(PERSON_IDENTIFIER, "BE/CA/54321"))
                .build();

        Assert.assertFalse(protocolProcessor.checkMandatoryAttributes(attributeMap));
    }


    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for natural person and representative natural person are present
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_NaturalPerson_RepresentativeNaturalPerson_AllAttributesPresent() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(REPV_PERSON_IDENTIFIER, setAttributeDefinitionStringValue(REPV_PERSON_IDENTIFIER, "BE/CA/12345"))
                .put(REPV_CURRENT_FAMILY_NAME, setAttributeDefinitionStringValue(REPV_CURRENT_FAMILY_NAME, "Smith"))
                .put(REPV_CURRENT_GIVEN_NAME, setAttributeDefinitionStringValue(REPV_CURRENT_GIVEN_NAME, "John"))
                .put(REPV_DATE_OF_BIRTH, setAttributeDefinitionDateValue(REPV_DATE_OF_BIRTH, "2024-03-18"))
                .put(REPV_PLACE_OF_BIRTH, setAttributeDefinitionStringValue(REPV_PLACE_OF_BIRTH, "anywhere"))
                .put(PERSON_IDENTIFIER,setAttributeDefinitionStringValue(PERSON_IDENTIFIER, "BE/CA/54321"))
                .put(CURRENT_FAMILY_NAME, setAttributeDefinitionStringValue(CURRENT_FAMILY_NAME, "Johnson"))
                .put(CURRENT_GIVEN_NAME, setAttributeDefinitionStringValue(CURRENT_GIVEN_NAME, "Long"))
                .put(DATE_OF_BIRTH, setAttributeDefinitionDateValue(DATE_OF_BIRTH,"2022-02-02"))
     ...
     */
    @Test
    public void testCheckMandatoryAttributes_NaturalPerson_Missing_Representative_Attributes() throws AttributeValueMarshallingException {
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when MDS attributes are missing for natural person being represented
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_NaturalPerson_Missing_NaturalPerson_Attributes() throws AttributeValueMarshallingException {
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for legal person are present
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_LegalPerson_AllAttributesPresent() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(LEGAL_PERSON_IDENTIFIER, setAttributeDefinitionStringValue(LEGAL_PERSON_IDENTIFIER,"BE/CA/54321"))
                .put(LEGAL_NAME, setAttributeDefinitionStringValue(LEGAL_NAME, "Business inc"))
                .put(VAT_REGISTRATION_NUMBER, setAttributeDefinitionStringValue(VAT_REGISTRATION_NUMBER,"second valid VAT"))
                .build();
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when MDS attributes are missing for legal person
     * <p>
     * Must succeed
     */
    @Test
    public void testValidateRepresentativeAttributes_LegalPerson_MissingAttributes() throws AttributeValueMarshallingException {
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for legal person and representative legal person are present
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_LegalPerson_RepresentativeLegalPerson_AllAttributesPresent() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(REPV_LEGAL_PERSON_IDENTIFIER, setAttributeDefinitionStringValue(REPV_LEGAL_PERSON_IDENTIFIER, "BE/CA/12345"))
                .put(REPV_LEGAL_NAME, setAttributeDefinitionStringValue(REPV_LEGAL_NAME, "Johnathan Legal Name"))
                .put(REPV_VAT_REGISTRATION_NUMBER, setAttributeDefinitionStringValue(REPV_VAT_REGISTRATION_NUMBER, "valid VAT"))
                .put(LEGAL_PERSON_IDENTIFIER, setAttributeDefinitionStringValue(LEGAL_PERSON_IDENTIFIER,"BE/CA/54321"))
                .put(LEGAL_NAME, setAttributeDefinitionStringValue(LEGAL_NAME, "Business inc"))
                .put(VAT_REGISTRATION_NUMBER, setAttributeDefinitionStringValue(VAT_REGISTRATION_NUMBER,"second valid VAT"))
                .build();
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when MDS attributes are missing for representative legal person
     * <p>
     * Must succeed
     */
    @Test
    public void testValidateRepresentativeAttributes_LegalPerson_MissingRepresentativeAttributes() throws AttributeValueMarshallingException {
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when MDS attributes are missing for legal person being represented
     * <p>
     * Must succeed
     */
    @Test
    public void testValidateRepresentativeAttributes_LegalPerson_MissingLegalAttributes() throws AttributeValueMarshallingException {
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for legal person are present and there is an extra attribute of type Other
     * <p>
     * Must succeed
     */
    @Test
    public void testCheckMandatoryAttributes_LegalPerson() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(SECTOR_SPECIFIC_OTHER, setAttributeDefinitionStringValue(SECTOR_SPECIFIC_OTHER, "X34"))
                .put(LEGAL_PERSON_IDENTIFIER, setAttributeDefinitionStringValue(LEGAL_PERSON_IDENTIFIER,"BE/CA/54321"))
                .put(LEGAL_NAME, setAttributeDefinitionStringValue(LEGAL_NAME, "Business inc"))
                .put(VAT_REGISTRATION_NUMBER, setAttributeDefinitionStringValue(VAT_REGISTRATION_NUMBER,"second valid VAT"))
                .build();
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for legal person and legal representation are present and there is an extra attribute of type Other
     * <p>
     * Must succeed
     */
    @Test
    public void testValidateRepresentativeAttributes_LegalPerson_MissingLegalAttributes3() throws AttributeValueMarshallingException {
     ...
     */
    @Test
    public void testCheckMandatoryAttributes_EmptyAttributes() throws AttributeValueMarshallingException {
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when No MDS attributes are present and there is an extra attribute of type Other
     * <p>
     * Must succeed: Return False
     */
    @Test
    public void testCheckMandatoryAttributes_OnlyNonMDS() throws AttributeValueMarshallingException {

        ImmutableAttributeMap attributeMap = new ImmutableAttributeMap.Builder()
                .put(SECTOR_SPECIFIC_OTHER)
                .build();
    ...
    /**
     * Test method for {@link EidasProtocolProcessor#checkMandatoryAttributes(ImmutableAttributeMap)}
     * when all MDS attributes for legal representation are present and there is an extra attribute of type Other
     * <p>
     * Must succeed: Return False
     */
    @Test
    public void testValidateRepresentativeAttributes_OnlyNonMDS() throws AttributeValueMarshallingException {
    ...
    public static final AttributeDefinition<String> SECTOR_SPECIFIC_OTHER = AttributeDefinition.<String>builder()
            .nameUri("ssa:CustomURI" + "/SSA")
            .friendlyName("SSA")
            .personType(PersonType.OTHER)
            .required(false)
            .uniqueIdentifier(false)
            .xmlType("custom:URI", "SSA", "ssa")
    ...
    private IAuthenticationResponse buildIAuthenticateResponse() {
        ...
        eidasAuthnResponseBuilder
                ...
                .statusMessage("TEST")
                .notBefore(ZonedDateTime.now(ZoneOffset.UTC))
                .notOnOrAfter(ZonedDateTime.now(ZoneOffset.UTC))
...
//                .levelOfAssurance(nonNotifiedLoA)
    ...
    private AttributeValue setAttributeDefinitionDateValue(AttributeDefinition<LocalDate> definition, String value) throws AttributeValueMarshallingException {
        return definition.getAttributeValueMarshaller().unmarshal(value, false);
    }
}