...
public class EidasMetadataGeneratorTest {
    ...
    private EidasMetadataRoleParametersI createMockRoleDescriptor(MetadataRole role) throws Exception {
        ...
        mockRoleDescriptor.setEncryptionCertificates(List.of(getCertificate(TEST_CERTIFICATE_PATH)));
        mockRoleDescriptor.setSigningCertificates(List.of(getCertificate(TEST_CERTIFICATE_PATH)));
