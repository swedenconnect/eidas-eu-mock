...
public class TestMDGenerator {
    ...
    private EidasMetadataParametersI createTestEidasMetadataParametersI() {
        ...
        mcp.setAssuranceLevels(List.of("http://eidas.europa.eu/LoA"));
        ...
        mcrp.setSigningCertificates(List.of(getTestCertificate()));
        mcrp.setEncryptionCertificates(List.of(getTestCertificate()));
        ...
        mcp.setRoleDescriptors(Set.of(mcrp));
        return mcp;
    }
    ...
    private X509Certificate getTestCertificate() {
        try {
            ...
            for (final Enumeration<String> e = testKeyStore.aliases(); e.hasMoreElements() && !find; ) {
                ...
                if (serialNum.equalsIgnoreCase(serialNumber) && null != issuerDN && issuerDN.equals(issuerDNConf)) {
                    alias = aliasCert;
                    find = true;
                }
            }
