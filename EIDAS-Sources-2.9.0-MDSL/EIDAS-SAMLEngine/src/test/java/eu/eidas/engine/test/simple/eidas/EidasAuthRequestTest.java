...
public class EidasAuthRequestTest {
    ...
    public void testGenerateAuthnRequestCountryErr() throws Exception {
        ...
        expectedException.expectMessage("citizenCountryCode cannot be null, empty or blank");
    ...
    public void testGenerateAuthnRequestLoAErr() throws EIDASSAMLEngineException, NoSuchFieldException, IllegalAccessException {
        expectedException.expect(EIDASSAMLEngineException.class);
        expectedException.expectMessage(EidasErrors.get(EidasErrorKey.INVALID_LOA_VALUE.errorMessage()));
    ...
    public void testValidateDataAuthnRequest() throws EIDASSAMLEngineException {
        ...
        assertEquals("Destination incorrect: ", request.getDestination(), destination);
        assertEquals("Service provider incorrect: ", request.getProviderName(), spName);
        assertEquals("Assertion consumer URL incorrect: ", request.getAssertionConsumerServiceURL(),
                assertConsumerUrl);
    }
    ...
    public void testValidateAuthnRequestNotTrustedErr1() throws EIDASSAMLEngineException {
        ...
        IAuthenticationRequest request = new EidasAuthenticationRequest.Builder()
