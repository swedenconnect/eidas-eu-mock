...
public class IncomingLightRequestValidatorLoAComponentTest {
    ...
    public void failOnDocumentBuilderIOException() throws SpecificCommunicationException, IOException, SAXException {
        ...
        try (MockedStatic<DocumentBuilderFactoryUtil> mockedStatic = Mockito.mockStatic(DocumentBuilderFactoryUtil.class)) {
            mockedStatic.when(() -> DocumentBuilderFactoryUtil.parse(ArgumentMatchers.any(InputStream.class)))
