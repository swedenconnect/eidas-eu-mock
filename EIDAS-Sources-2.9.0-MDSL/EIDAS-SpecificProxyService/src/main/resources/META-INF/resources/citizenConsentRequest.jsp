...
<c:set var="definedPersonTypes">NaturalPerson, LegalPerson, RepresentativeLegalPerson, RepresentativeNaturalPerson</c:set>
                ...
                <div class="col-right-content">
                    ...
                    <form id="consentSelector" name="consentSelector" method="${e:forHtml(binding)}"
                        ...
                        <div id="slider1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6"><% /** Others */ %>
                                    <c:set var="categoryIsDisplayed" value="false"/>
                                    <c:forEach items="${attrList}" var="attrItem">
                                    <c:if test="${attrItem.key.required && !definedPersonTypes.contains(attrItem.key.personType.value)}">
                                    <c:if test="${categoryIsDisplayed=='false'}">
                                    <h3><fmt:message key="presentConsent.natural" bundle="${i18n_eng}"/>
                                        <span><fmt:message key="presentConsent.person" bundle="${i18n_eng}"/></span>
                                    </h3>
                        ...
                        <div id="slider2">
                            ...
                            <div class="row">
                                <div class="col-sm-3"></div>
                                <div class="col-sm-6"><% /** Other attributes */ %>
                                    <c:set var="categoryIsDisplayed" value="false"/>
                                    <c:forEach items="${attrList}" var="attrItem">
                                    <c:if test="${!attrItem.key.required && !definedPersonTypes.contains(attrItem.key.personType.value)}">
                                    <c:if test="${categoryIsDisplayed=='false'}">
                                    <h3>
                                        <fmt:message key="presentConsent.others" bundle="${i18n_eng}"/>
                                    </h3>
                                    <c:set var="categoryIsDisplayed" value="true"/>
                                    <ul class="toogle-switch list-unstyled">
                                        </c:if>
                                    ...
                                    <div id="slider3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6"><% /** Others */ %>
                                                ...
                                                <c:if test="${attrItem.key.required && !definedPersonTypes.contains(attrItem.key.personType.value)}">
                                                <c:if test="${categoryIsDisplayed=='false'}">
                                                <h3><fmt:message key="presentConsent.others" bundle="${i18n_eng}"/></h3>
                                                <c:set var="categoryIsDisplayed" value="true"/>
                                                <ul class="list-unstyled check">
                                                    </c:if>
                                                    <li>
...
<script type="text/javascript" src="js/presentConsent.js" nonce="${cspScriptNonce}"></script>
