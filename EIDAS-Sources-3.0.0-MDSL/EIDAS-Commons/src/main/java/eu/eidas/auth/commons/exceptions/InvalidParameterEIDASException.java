...
public class InvalidParameterEIDASException extends AbstractEIDASException {
     ...
     */
    public InvalidParameterEIDASException(final String errorCode, final String errorMessage) {
     ...
     */
    public InvalidParameterEIDASException(final String errorCode, final String errorMessage, final String additionalInformation) {
    ...
    /**
     * Exception Constructor with one String representing the exception additionalInformation.
     *
     * @param additionalInformation The exception additionalInformation.
     */
    public InvalidParameterEIDASException(final String additionalInformation) {
