...
public final class RepresentativeLegalPersonSpec {
    ...
    public static final class Definitions {
        ...
        public static final AttributeDefinition<String> LEGAL_PHONE_NUMBER = AttributeDefinition.<String>builder()
                .nameUri(Namespace.URI + "/LegalPhoneNumber")
                .friendlyName("RepresentativeLegalPhoneNumber")
                .personType(PersonType.REPV_LEGAL_PERSON)
                .xmlType(Namespace.URI, "LegalPhoneNumberType", Namespace.PREFIX)
                .attributeValueMarshaller(new LiteralStringAttributeValueMarshaller())
                .build();

        public static final AttributeDefinition<String> LEGAL_EMAIL_ADDRESS = AttributeDefinition.<String>builder()
                .nameUri(Namespace.URI + "/LegalEmailAddress")
                .friendlyName("RepresentativeLegalEmailAddress")
                .personType(PersonType.REPV_LEGAL_PERSON)
                .xmlType(Namespace.URI, "LegalEmailAddressType", Namespace.PREFIX)
                .attributeValueMarshaller(new LiteralStringAttributeValueMarshaller())
                .build();
    ...
    public static final AttributeRegistry REGISTRY =
            AttributeRegistries.of(Definitions.LEGAL_PERSON_IDENTIFIER, Definitions.LEGAL_NAME,
                    ...
                    Definitions.LEGAL_PHONE_NUMBER, Definitions.LEGAL_EMAIL_ADDRESS);
