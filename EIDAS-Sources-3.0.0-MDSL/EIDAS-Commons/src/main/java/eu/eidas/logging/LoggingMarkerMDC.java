 ...
 * @since 1.2.2
 */
public interface LoggingMarkerMDC {
    ...
    /*Dedicated marker for the Full message exchange logging*/
    public static final Marker FULL_MSG_EXCHANGE = MarkerFactory.getMarker("FULL_MESSAGE_EXCHANGE");
}
