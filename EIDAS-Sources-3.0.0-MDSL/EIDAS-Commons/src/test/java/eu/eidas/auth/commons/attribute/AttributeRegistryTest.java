...
public final class AttributeRegistryTest {
     ...
     */
    @Test
    public void testLogRetrievedAttributesTrace() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
     ...
     */
    @Test
    public void testLogRetrievedAttributesIoException() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
        ...
        final List accessors = new ArrayList();
        accessors.add(mockAccessor);

        AttributeDefinitionDao mockedDao = Mockito.mock(AttributeDefinitionDao.class);
        AttributeRegistry testRegistry = new AttributeRegistry(mockedDao);
    ...
    public void testGetAttributes() {
        SortedSet<AttributeDefinition<?>> attributes = attributeRegistry.getAttributes();
    ...
    public void testGetAttributesIoException() throws IOException {
        ...
        Mockito.when(mockAccessor.get()).thenReturn(Mockito.mock(SortedSet.class));
        final List accessors = new ArrayList();
        accessors.add(mockAccessor);
    ...
    public void testGetAttributesGetByFilterIoException() throws NoSuchFieldException, IllegalAccessException, IOException {
        ...
        List mockAccessors = List.of(mockAccessorOne, mockAccessorTwo);
        AttributeDefinitionDao mockedDao = Mockito.mock(AttributeDefinitionDao.class);
        AttributeRegistry testRegistry = new AttributeRegistry(mockedDao);
    ...
    public void testGetByFriendlyName() {
        SortedSet<AttributeDefinition<?>> attributes = attributeRegistry.getByFriendlyName("FamilyName");
    ...
    public void testGetByRequiredTrue() {
        SortedSet<AttributeDefinition<?>> attributes = attributeRegistry.getByRequired(true);
    ...
    public void testGetByRequiredFalse() {
        SortedSet<AttributeDefinition<?>> attributes = attributeRegistry.getByRequired(false);
    ...
    public void testGetByPersonTypeNatural() {
        SortedSet<AttributeDefinition<?>> attributes =
    ...
    public void testGetByPersonTypeLegal() {
        SortedSet<AttributeDefinition<?>> attributes = attributeRegistry.getByPersonType(PersonType.LEGAL_PERSON);
    ...
    public void testGetByXmlType() {
        SortedSet<AttributeDefinition<?>> attributes = attributeRegistry.getByXmlType(
