...
import static eu.eidas.auth.commons.protocol.eidas.impl.LevelOfAssuranceTestConstants.*;
...
public class AbstractEidasAuthenticationRequestBuilderTest {
    ...
    @Test
    public void equalsForLevelOfAssurance() {
        final AbstractEidasAuthenticationRequest.AbstractBuilder builder1 = AbstractEidasAuthenticationRequestBuilderTest
                .createEmptyEidasAuthenticationRequestBuilder();
        final AbstractEidasAuthenticationRequest.AbstractBuilder builder2 = AbstractEidasAuthenticationRequestBuilderTest
                .createEmptyEidasAuthenticationRequestBuilder();

        populateMinimalBuilderFields(builder1);
        populateMinimalBuilderFields(builder2);

        builder1.levelOfAssuranceComparison(LevelOfAssuranceTestConstants.LEVEL_OF_ASSURANCE_COMPARISON_EXACT_STRING);
        final List<LevelOfAssurance> levelOfAssurances1 = new ArrayList<>();
        levelOfAssurances1.add(LevelOfAssurance.build(LEVEL_OF_ASSURANCE_NOTIFIED_HIGH));
        levelOfAssurances1.addAll(NON_NOTIFIED_LEVELS_OF_ASSURANCE);
        builder1.levelsOfAssurance(levelOfAssurances1);

        builder2.levelOfAssuranceComparison(LevelOfAssuranceTestConstants.LEVEL_OF_ASSURANCE_COMPARISON_EXACT_STRING);
        final List<LevelOfAssurance> levelOfAssurances2 = new ArrayList<>();
        levelOfAssurances2.add(LevelOfAssurance.build(LEVEL_OF_ASSURANCE_NOTIFIED_HIGH));
        levelOfAssurances2.add(LevelOfAssurance.build(LEVEL_OF_ASSURANCE_NOTIFIED_SUBSTANTIAL));
        levelOfAssurances2.add(LevelOfAssurance.build(LEVEL_OF_ASSURANCE_NOTIFIED_LOW));
        levelOfAssurances2.addAll(NON_NOTIFIED_LEVELS_OF_ASSURANCE);
        builder2.levelsOfAssurance(levelOfAssurances2);

        final AbstractEidasAuthenticationRequest x = (AbstractEidasAuthenticationRequest) builder1.build();
        final AbstractEidasAuthenticationRequest y = (AbstractEidasAuthenticationRequest) builder2.build();
    ...
    @Test
    public void equalsForNonNotifiedLevelOfAssurance() {
        final AbstractEidasAuthenticationRequest.AbstractBuilder builder1 = AbstractEidasAuthenticationRequestBuilderTest
                .createEmptyEidasAuthenticationRequestBuilder();
        final AbstractEidasAuthenticationRequest.AbstractBuilder builder2 = AbstractEidasAuthenticationRequestBuilderTest
                .createEmptyEidasAuthenticationRequestBuilder();
        ...
        builder1.levelOfAssuranceComparison(LevelOfAssuranceTestConstants.LEVEL_OF_ASSURANCE_COMPARISON_EXACT_STRING);
        final List<LevelOfAssurance> levelOfAssurances1 = new ArrayList<>();
        levelOfAssurances1.add(LevelOfAssurance.build(NON_NOTIFIED_LOA_ALPHA));
        builder1.levelsOfAssurance(levelOfAssurances1);

        builder2.levelOfAssuranceComparison(LevelOfAssuranceTestConstants.LEVEL_OF_ASSURANCE_COMPARISON_EXACT_STRING);
        final List<LevelOfAssurance> levelOfAssurances2 = new ArrayList<>();
        levelOfAssurances2.add(LevelOfAssurance.build(NON_NOTIFIED_LOA_BETA));
        builder2.levelsOfAssurance(levelOfAssurances2);
