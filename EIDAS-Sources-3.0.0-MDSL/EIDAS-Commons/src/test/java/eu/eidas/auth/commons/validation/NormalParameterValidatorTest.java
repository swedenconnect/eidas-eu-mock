...
public class NormalParameterValidatorTest {
    ...
    public void testValidRequestValueBaseValidatorValid() {
        String samlRequestValid = generateRequestSaml(GenerationType.NORMAL);
        NormalParameterValidator.paramName(EidasParameterKeys.SAML_REQUEST).paramValue(samlRequestValid).validate();
    }
     ...
     */
    @Test
    public void testResponseValueExceedsLimitWithoutKey() {
        expectedException.expect(InvalidParameterEIDASException.class);
        String samlResponse = generateResponseSaml(GenerationType.OVERLIMIT);
        ...
        NormalParameterValidator.paramName(EidasParameterKeys.SAML_IN_RESPONSE_TO).paramValue(samlResponse).validate();
    }
     ...
     */
    @Test
    public void testRequestValueExceedsLimitWithoutKey() {
        expectedException.expect(InvalidParameterEIDASException.class);
        String samlRequest = generateRequestSaml(GenerationType.OVERLIMIT);

        //In this test, the EidasParameterKeys.SAML_REQUEST is replaced by EidasParameterKeys.SAML_IN_RESPONSE_TO to simulate a missing configuration.
        NormalParameterValidator.paramName(EidasParameterKeys.SAML_IN_RESPONSE_TO).paramValue(samlRequest).validate();
    }
