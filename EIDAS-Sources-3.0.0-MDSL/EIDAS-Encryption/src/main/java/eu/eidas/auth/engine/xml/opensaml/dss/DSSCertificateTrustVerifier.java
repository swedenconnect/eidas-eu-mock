...
public class DSSCertificateTrustVerifier implements CertificateTrustVerifier {
    ...
    public void verify(@Nonnull final X509Credential target,
        ...
        final SignatureValidationAlerter signatureValidationAlerter = new SignatureValidationAlerter(signatureValidationContext);
        ...
        signatureValidationAlerter.assertCertificateNotRevoked(certificateToValidate);
