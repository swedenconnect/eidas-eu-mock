 ...
 */
public class HazelcastInstanceInitializerSpecificCommunication implements HazelcastInstanceInitializer {

    private static final Logger LOG = LoggerFactory.getLogger(HazelcastInstanceInitializerSpecificCommunication.class.getName());
    ...
    public HazelcastInstance getInstance() {
        return getInstance(this.hazelcastInstanceName);
    }
