...
public class HazelcastInstanceInitializerTest {
    ...
    public void initializeInstance() throws FileNotFoundException {
        ...
        HazelcastInstanceInitializerSpecificCommunication hazelcastInstanceInitializer = HazelcastInstanceInitializerTestUtil.createHazelcastInstanceInitializer(testHazelcastInstanceName, hazelcastConfigfileName);
