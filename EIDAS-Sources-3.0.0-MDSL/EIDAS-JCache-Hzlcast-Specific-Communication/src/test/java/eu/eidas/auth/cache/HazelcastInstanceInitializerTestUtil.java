...
public class HazelcastInstanceInitializerTestUtil {
     ...
     */
    @Nonnull
    public static HazelcastInstanceInitializerSpecificCommunication createHazelcastInstanceInitializer(final String testHazelcastInstanceName, final String hazelcastConfigfileName) throws FileNotFoundException {
        HazelcastInstanceInitializerSpecificCommunication hazelcastInstanceInitializer = new HazelcastInstanceInitializerSpecificCommunication();
    ...
    public static void shutdownHazelcastInstance(@Nonnull final String testHazelcastInstanceName) {
        HazelcastInstance actualHazelcastInstance = HazelcastInstanceInitializerSpecificCommunication.getInstance(testHazelcastInstanceName);
