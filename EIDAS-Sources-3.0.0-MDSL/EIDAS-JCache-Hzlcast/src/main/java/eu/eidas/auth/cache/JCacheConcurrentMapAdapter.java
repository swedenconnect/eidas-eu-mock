...
/**
 * This class is an implementation of an Adapter Design Pattern to adapt a {@link ConcurrentMap} to the {@link Cache}.
 * <p>
 * Uses, when possible, similar methods of {@link ConcurrentMap}.
 * When not possible, implements code to achieve the description of each method in {@link Cache} API as much as possible.
 *
...
public class JCacheConcurrentMapAdapter<K, V> implements Cache<K, V> {
    ...
    @Override
    public void close() {
        // No-op: Hazelcast IMap instances are managed by the HazelcastInstance lifecycle.
        // Closing an individual IMap is not supported, as resources are released when the
        // HazelcastInstance itself is shut down. This method is overridden only to fulfill
        // the javax.cache.Cache interface contract.
    }
    ...
    public ConcurrentMap<K, V> getInternalMap() {
