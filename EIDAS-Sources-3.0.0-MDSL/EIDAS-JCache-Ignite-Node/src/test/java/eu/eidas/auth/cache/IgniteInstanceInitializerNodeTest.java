...
public class IgniteInstanceInitializerNodeTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(IgniteInstanceInitializerNodeTest.class.getName());
    ...
    public void setupTest() {
        // nothing extra tested here, see setup and teardown
    }

    /**
     * Stops Ignite's instance created by {@link ()}.
     */
    @AfterClass
