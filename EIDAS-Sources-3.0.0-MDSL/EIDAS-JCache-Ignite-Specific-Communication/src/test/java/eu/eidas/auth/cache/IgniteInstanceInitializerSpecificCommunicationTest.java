...
public class IgniteInstanceInitializerSpecificCommunicationTest {
    ...
    public static void stopIgnite() {
        String instanceName = (igniteInstanceInitializerSpecificCommunication.getInstance()).name();
    ...
    /**
     * Tests that the "demoCacheName" cache has statistics enabled
     * as configured in the Ignite XML file.
     * <p>
     * Must succeed.
     */
    @Test
    public void testCacheStatisticsEnabled() {
        Ignite ignite = igniteInstanceInitializerSpecificCommunication.getInstance();
        IgniteCache<?, ?> cache = ignite.cache("demoCacheName");
