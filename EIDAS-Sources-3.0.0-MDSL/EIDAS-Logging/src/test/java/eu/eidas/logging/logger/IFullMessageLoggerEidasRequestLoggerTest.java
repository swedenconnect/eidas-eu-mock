...
public class IFullMessageLoggerEidasRequestLoggerTest {
    ...
    private final Logger fullMessageLogger = (Logger) LoggerFactory.getLogger(
            IFullMessageLogger.getLoggerName(TestEidasRequestLogger.class)
    );
    ...
    public void setup() {
        ...
        eidasRequestLogger.setMessageLoggerUtils(mockedMessageLoggerUtils);
    ...
    /**
     * Test method for {@link EidasRequestLogger#logFullMessage(HttpServletRequest)}.
    ...
    public void logFullMessageActive() {
        ...
        eidasRequestLogger.logFullMessage(testRequest);
    ...
    private static class TestEidasRequestLogger extends EidasRequestLogger {
        ...
        @Override
        protected void setMessageVector(@Nonnull EidasRequestMessageLog.Builder messageLogBuilder, @Nonnull HttpServletRequest httpServletRequest, IAuthenticationRequest authenticationRequest) {
