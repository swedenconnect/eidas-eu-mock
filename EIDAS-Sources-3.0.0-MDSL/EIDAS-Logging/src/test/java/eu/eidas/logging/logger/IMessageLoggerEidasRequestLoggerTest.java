...
public class IMessageLoggerEidasRequestLoggerTest {
    ...
    /**
     * Test method for {@link EidasRequestLogger#logMessage(HttpServletRequest)}
    ...
    /**
     * Test method for {@link {@link EidasRequestLogger#logMessage(HttpServletRequest)}
    ...
    /**
     * Test method for {@link EidasRequestLogger#logMessage(HttpServletRequest)}
     * when an error occurs within {@link eu.eidas.node.auth.connector.AUCONNECTORUtil#loadConfigServiceMetadataURL(String)}
     * All information that can be logged should be logged anyway
     * <p>
     * Error scenario
     */
