...
public class IMessageLoggerLightResponseLoggerTest {
    ...
    private LightResponseLogger lightResponseLogger;
    ...
    public void setup() {
        ...
        lightResponseLogger = new TestLightResponseLogger();
        lightResponseLogger.setMessageLoggerUtils(mockMessageLoggerUtils);
        lightResponseLogger.setSpringManagedSpecificCommunicationLoggingService(mockSpecificCommunicationLoggingService);
    }
    ...
    /**
     * Test method for {@link LightResponseLogger#logMessage(HttpServletRequest)}
    ...
    public void logMessageInactive() throws Exception {
        ...
        lightResponseLogger.setMessageLoggerUtils(mockMessageLoggerUtils(testData));

        lightResponseLogger.logMessage(mockHttpServletRequest(testData, new String[]{testData.tokenBase64}));
    ...
    public void logMessageActive() throws Exception {
        ...
        lightResponseLogger.setMessageLoggerUtils(mockMessageLoggerUtils(testData));
        lightResponseLogger.setSpringManagedSpecificCommunicationLoggingService(mockSpecificCommunicationLoggingService(testData));
    ...
    public void testTwoTokensHttpRequestGoodTokenLast() throws Exception {
        ...
        lightResponseLogger.logMessage(mockHttpServletRequest(testData, tokenBase64Array));
    ...
    public void testLogOfInvalidLightResponse() throws SpecificCommunicationException {
        ...
        lightResponseLogger.logMessage(mockHttpServletRequest);
