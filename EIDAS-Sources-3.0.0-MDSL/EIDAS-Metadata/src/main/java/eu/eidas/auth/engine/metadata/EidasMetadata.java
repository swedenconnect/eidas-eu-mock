...
public class EidasMetadata {
    ...
    private EidasMetadata(@Nonnull Generator generator) {
    ...
    public static final class Generator {
        ...
        public Generator(@Nonnull EidasMetadataParametersI emp) {
            ...
            this.additionalNameIDFormats = emrp.getNameIDFormats();
        ...
        private void addNameIdFormatsToDescriptor(SSODescriptor ssoDescriptor, Set<String> configuredNameIdFormats) throws EIDASMetadataException {
            if (configuredNameIdFormats == null || configuredNameIdFormats.isEmpty()) {
                configuredNameIdFormats = Set.of(NameIDType.UNSPECIFIED); // zero NameIdFormats == Unspecified (spec)
            }

            for (String nameIDFormat : configuredNameIdFormats) {
