...
/**
 * This value object interface is responsible to present ALL data items for an eIDAS Metadata, including
 ...
 * <p>
 * use MetadataConfiguration to get a raw instance.
...
public interface EidasMetadataParametersI extends Serializable {
     ...
     */
    //TODO EIDINT-8022 Refactor getSigningMethods and setDigestMethods to handle a list instead of a concatenated string
     ...
     *
     * @return Java representation of datetime
     */
     ...
     */
    void setValidUntil(ZonedDateTime validityDuration);
    ...
    /**
     * Sets the interconnection graph data.
     *
     * @param interconnectionGraphData model object.
     */
    void setInterconnectionGraphData(@Nullable InterconnectionGraphData interconnectionGraphData);

    /**
     * Getter for interconnection graph data.
     *
     * @return The interconnection graph data model or null if the interconnection graph feature is disabled.
     */
    @Nullable
    InterconnectionGraphData getInterconnectionGraphData();

    List<X509Certificate> getTrustChain();

    void setTrustChain(List<X509Certificate> trustAnchor);
}
