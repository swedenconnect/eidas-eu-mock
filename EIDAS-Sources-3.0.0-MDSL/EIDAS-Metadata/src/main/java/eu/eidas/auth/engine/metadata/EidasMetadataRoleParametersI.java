...
public interface EidasMetadataRoleParametersI extends Serializable {
     ...
     */
    List<X509Certificate> getEncryptionCertificates();

    void setEncryptionCertificates(List<X509Certificate> encryptionCredential);
     ...
     * @return X509 type certificate
     */
    List<X509Certificate> getSigningCertificates();

    void setSigningCertificates(Collection<X509Certificate> signingCredential);
     ...
     *
     * @return a map of possible SAML bindings and endpoint locations offered.
     */
     ...
     */
    //TODO EIDINT-8021 Refactor getEncryptionAlgorithms and setEncryptionAlgorithms to handle a list instead of a concatenated string
    ...
    /**
     * Returns the set of Service supported attributes, represented as a sorted set of full name URIs
     * as defined in the EIDAS profile.
     *
     * @return a sorted set of Service-supported attributes
     */
    SortedSet<String> getSupportedAttributes();
     ...
     */
    void setSupportedAttributes(SortedSet<String> supportedAttributes);

    /**
     * Returns the set of Service supported NameID formats as a set of full URIs.
     *
     * @return the set of Service-supported NameID formats.
     */
