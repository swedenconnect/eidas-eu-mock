...
public class NodeCountryTypeMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected final void marshallElementContent(final XMLObject samlObject, final Element domElement) {
        final NodeCountryType nodeCountryType = (NodeCountryType) samlObject;
        XMLHelper.appendTextContent(domElement, nodeCountryType.getNodeCountry());
    }
}
