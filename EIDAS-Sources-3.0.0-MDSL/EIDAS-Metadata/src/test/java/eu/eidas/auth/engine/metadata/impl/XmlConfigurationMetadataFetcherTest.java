...
public class XmlConfigurationMetadataFetcherTest {
     ...
     * when URL not is not a valid absolute uri  see {@link BaseMetadataFetcher#isValidUri(String)}
     *
     ...
     */
    @Test
    public void testURLNotValidUri() throws EIDASMetadataException {
        thrown.expect(EIDASMetadataProviderException.class);
        thrown.expectMessage(containsString("Metadata URL format is invalid"));

        whitelistMetadataFetcher.getEidasMetadata("notAnAbsoluteUri", mockMetadataSigner, null);
    }
    ...
    public void testURLNotAllowed() throws EIDASMetadataException {
        ...
        whitelistMetadataFetcher.getEidasMetadata("tel:notSecureUrlResource", mockMetadataSigner, null);
    }
