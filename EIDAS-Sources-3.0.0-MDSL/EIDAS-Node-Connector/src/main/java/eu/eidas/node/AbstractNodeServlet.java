            ...
            if (request.getCookies() != null && request.isRequestedSessionIdFromCookie()) {
                ...
                for (Cookie cookie : request.getCookies()) {
                    ...
                    if (currentSession.equals(requestedSessionId)) {
                        ...
                        //TODO EIDINT-8016 Investigate and Update Session Cookie Handling
                        //
...
//NOSONAR                 response.addCookie(cookie);
    ...
    protected final boolean acceptsHttpRedirect() {
        AUCONNECTORUtil auconnectorUtil = BeanProvider.getBean(AUCONNECTORUtil.class);
        Boolean acceptGet = Boolean.parseBoolean(auconnectorUtil.getConfigs().getProperty(EidasParameterKeys.ALLOW_REDIRECT_BINDING.toString()));
