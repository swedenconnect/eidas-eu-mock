...
import static eu.eidas.node.auth.tls.EIDASCipherSuite.TLS_AES_128_GCM_SHA256;
import static eu.eidas.node.auth.tls.EIDASCipherSuite.TLS_AES_256_GCM_SHA384;
import static eu.eidas.node.auth.tls.EIDASCipherSuite.TLS_CHACHA20_POLY1305_SHA256;
...
import static eu.eidas.node.auth.tls.EIDASCipherSuite.TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256;
...
import static eu.eidas.node.auth.tls.EIDASCipherSuite.TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256;
...
public class EidasCipherSuiteTest {
    ...
    public void selectCipherSuiteTls12AndCurrentJdk() {
        CipherSuiteTestData testData = new CipherSuiteTestData()
                ...
                .setJdkVersions(JDK_11)
                .buildCipherSuites();
        assertThat(testData.getCipherSuites(), hasSize(16));
        assertThat(testData.getCipherSuites(), containsInAnyOrder(
                TLS_DHE_RSA_WITH_AES_128_CBC_SHA,
                TLS_DHE_RSA_WITH_AES_256_CBC_SHA,
    ...
    @Test
    public void selectCipherSuiteTls13AndCurrentJdk() {
        CipherSuiteTestData testData = new CipherSuiteTestData()
                .setTlsVersions(TLS1_3)
                .setJdkVersions(JDK_11)
                .buildCipherSuites();
        assertThat(testData.getCipherSuites(), hasSize(3));
        assertThat(testData.getCipherSuites(), containsInAnyOrder(
