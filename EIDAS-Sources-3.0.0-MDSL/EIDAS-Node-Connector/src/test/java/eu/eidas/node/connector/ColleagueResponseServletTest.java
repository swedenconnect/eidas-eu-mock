...
public class ColleagueResponseServletTest {
    ...
    SpecificCommunicationService mockSpecificCommunicationService;
    ...
    private void mockSpecificCommunicationService(BinaryLightToken binaryLightToken) throws Exception {
        mockSpecificCommunicationService =
                Mockito.mock(SpecificCommunicationService.class);
        ...
        beanName = ConnectorBeanNames.SPECIFIC_CONNECTOR_DEPLOYED_JAR.toString();
    ...
    public void relayStateInStoredEidasSamlRequestSetInLightResponse() throws Exception {
        ...
        colleagueResponseServlet.doPost(mockRequest, Mockito.mock(HttpServletResponse.class));
    ...
    private MockHttpServletRequest createMockHttpServletRequest() {
        MockHttpServletRequest mockRequest = new MockHttpServletRequest(HttpMethod.POST.name(), null);
