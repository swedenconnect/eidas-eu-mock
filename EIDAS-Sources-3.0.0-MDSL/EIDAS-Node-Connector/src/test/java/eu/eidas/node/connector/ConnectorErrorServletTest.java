...
public class ConnectorErrorServletTest {
    ...
    public void testDoPost() throws Exception {
        ...
        Mockito.when(mockHttpServletRequest.getAttribute(RequestDispatcher.ERROR_EXCEPTION)).thenReturn(connectorError);
    ...
    /**
     * Test method for
     * {@link ConnectorErrorServlet#populateResponseHeader(SecurityResponseHeaderHelper, HttpServletRequest, HttpServletResponse)}
     * <p>
     * Must succeed
     */
    @Test
