...
public class IMessageLoggerLightRequestLoggerTest {
    ...
    /**
     * Test method for {@link LightRequestLogger#logMessage(HttpServletRequest)}
    ...
    public void logMessageActive() throws Exception {
        ...
        LightRequestLogger lightRequestLogger = connectorIncomingLightRequestLogger(testData);
