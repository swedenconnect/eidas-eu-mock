...
public class IFullMessageLoggerLightResponseLoggerTest {
    ...
    /**
     * Test method for {@link LightResponseLogger#logFullMessage(HttpServletRequest)}
    ...
    public void logFullMessage() throws Exception {
        ...
        lightResponseLogger.logFullMessage(mockHttpServletRequest(testData));
    ...
    /**
     * Test method for {@link LightResponseLogger#logFullMessage(HttpServletRequest)}
     * call the {@link SpecificCommunicationLoggingService#getResponse(String)} with the expected Error of {@link SpecificCommunicationException}
