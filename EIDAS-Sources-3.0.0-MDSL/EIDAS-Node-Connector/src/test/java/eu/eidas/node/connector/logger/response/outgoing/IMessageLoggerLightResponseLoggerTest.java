...
public class IMessageLoggerLightResponseLoggerTest {
    ...
    public void setup() {
        ...
        lightResponseLogger = new ConnectorOutgoingLightResponseLogger();
        ...
        ((ConnectorOutgoingLightResponseLogger) lightResponseLogger)
     ...
     */
    @Test
    public void logMessageInactive() {
        ...
        lightResponseLogger.logMessage(mockHttpServletRequest(testData));
