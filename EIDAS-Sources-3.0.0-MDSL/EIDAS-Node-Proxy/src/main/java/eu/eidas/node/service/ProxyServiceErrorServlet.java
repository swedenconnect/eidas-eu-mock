...
public class ProxyServiceErrorServlet extends AbstractNodeServlet {
    ...
    public void doPost(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        final AbstractEIDASException abstractEIDASException = (AbstractEIDASException) httpServletRequest.getAttribute(RequestDispatcher.ERROR_EXCEPTION);
    ...
    private void populateResponseHeader(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        ...
        try {
            ...
            httpServletRequest.setAttribute(RequestDispatcher.ERROR_EXCEPTION, new ProxyServiceError(
