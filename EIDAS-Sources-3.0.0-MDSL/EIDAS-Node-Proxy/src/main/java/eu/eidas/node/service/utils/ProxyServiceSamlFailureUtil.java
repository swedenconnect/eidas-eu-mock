...
public class ProxyServiceSamlFailureUtil {
    ...
    private static String getMetadataAssertionConsumerUrl(ProtocolEngineI protocolEngine, IAuthenticationRequest authenticationRequest) {
    ...
    private static EidasMetadataParametersI getIssuerMetadataParameters(ProtocolEngineI engine, String issuer) {
