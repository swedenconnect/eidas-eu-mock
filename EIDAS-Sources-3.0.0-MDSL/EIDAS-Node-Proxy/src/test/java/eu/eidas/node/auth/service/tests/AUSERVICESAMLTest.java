...
public class AUSERVICESAMLTest {
    ...
    public void setUp() throws Exception {
        ...
        auServiceSaml.setNameIdFormatList("urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified");
        ...
        Mockito.when(mockProtocolEngine.getProtocolProcessor()).thenReturn(mockProtocolProcessorI);

        Mockito.when(mockProtocolProcessorI.getMetadataParameters(anyString()))
                .thenAnswer((Answer<HighLevelMetadataParamsI>) invocationOnMock -> new HighLevelMetadataParams(mockConnectorMetadataParameters));
    }
    ...
    public void testProcessConnectorRequestWhenRequestIsUnsupported() throws EIDASSAMLEngineException {
        ...
        mockGenerateResponseErrorMessageMethod(mockProtocolEngine);
     ...
     */
    @Test
    public void testGetIssuerMetadataParametersWhenEIDASSAMLEngineExceptionIsThrown() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, EIDASMetadataException, EIDASSAMLEngineException {
        ...
        Mockito.when(mockProtocolProcessorI.getMetadataParameters(anyString())).thenThrow(EIDASSAMLEngineException.class);

        getIssuerMetadataParametersMethod.invoke(auServiceSaml, mockProtocolEngine, "issuer");
    }
    ...
    public void testCheckAttributeList() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        final Set<AttributeDefinition<?>> definitions = ATTRIBUTE_MAP.getDefinitions();
    ...
    public void testCheckAttributeListWithUnsupportedMandatoryAttributes() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, EIDASSAMLEngineException {
        ...
        checkAttributeListMethod.setAccessible(true);
        final ImmutableAttributeMap mockImmutableAttributeMap = Mockito.mock(ImmutableAttributeMap.class);
        final Set<AttributeDefinition<?>> mapDefinitions = ATTRIBUTE_MAP.getDefinitions();
        final Set<String> unsupportedAttributes = new HashSet<>();
    ...
    /**
     * Test method for {@link AUSERVICESAML#checkNameIDFormat(IAuthenticationRequest)}.
     * Verifies that no exception is thrown when the request contains a NameID format
     * that is part of the configured nameIdFormatList.
     * <p>
     * Must succeed.
     */
    @Test
    public void testCheckNameIDFormat() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        auServiceSaml.setNameIdFormatList(NameIDType.UNSPECIFIED);
        Mockito.when(mockAuthenticationRequest.getNameIdFormat()).thenReturn(NameIDType.UNSPECIFIED);
    ...
    /**
     * Test method for {@link AUSERVICESAML#checkNameIDFormat(IAuthenticationRequest)}.
     * Verifies that a {@link SamlFailureResponseException} is thrown when the request
     * contains a NameID format that is not part of the configured nameIdFormatList.
     * <p>
     * Must fail.
     */
    @Test
    public void testCheckNameIDFormatWithInvalidNameIdFormat() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        expectedException.expectCause(isA(SamlFailureResponseException.class));

        final Method checkNameIDFormatMethod = AUSERVICESAML.class.getDeclaredMethod("checkNameIDFormat", IAuthenticationRequest.class);
        checkNameIDFormatMethod.setAccessible(true);

        auServiceSaml.setNameIdFormatList(NameIDType.PERSISTENT);
        Mockito.when(mockAuthenticationRequest.getNameIdFormat()).thenReturn(NameIDType.UNSPECIFIED);
    ...
    public void testValidateRequestedAttributesForProtocol_Protocol12() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        final Set<AttributeDefinition<?>> definitions = attributeMap.getDefinitions();
    ...
    private void mockGenerateResponseErrorMessageMethod(ProtocolEngineI mockProtocolEngine) {
    ...
    private EidasMetadataParametersI mockEidasMetadataRoleParameters() throws EIDASMetadataException, EIDASSAMLEngineException {
    ...
    private EidasMetadataParametersI mockEidasMetadataParameters() throws EIDASSAMLEngineException {
