...
class CipherSuiteTestData {
    ...
    CipherSuiteTestData buildCipherSuites() {
        Objects.requireNonNull(tlsVersions, "tlsVersions cannot be null");
        Objects.requireNonNull(jdkVersions, "jdkVersions cannot be null");
        if (tlsVersions.isEmpty() && jdkVersions.isEmpty()) {
            throw new IllegalArgumentException("tlsVersions and jdkVersions cannot be both empty");
        }
