...
public class IFullMessageLoggerEidasResponseLoggerTest {
    ...
    private final Logger fullMessageLogger = (Logger) LoggerFactory.getLogger(
            IFullMessageLogger.getLoggerName(ProxyServiceOutgoingEidasResponseLogger.class)
    );
    ...
    public void setup() {
        ...
        eidasResponseLogger.setMessageLoggerUtils(mockedMessageLoggerUtils);
    ...
    /**
     * Test method for {@link EidasResponseLogger#logFullMessage(HttpServletRequest)}.
    ...
    public void logFullMessageActive() {
        ...
        eidasResponseLogger.logFullMessage(testRequest);
    ...
    public void logFullMessageUTF16_BE() {
        ...
        HttpServletRequest testRequest = mockHttpServletRequest(requestInUTF16BE);
    ...
    private HttpServletRequest mockHttpServletRequest(String testRequest) {
        ...
        Mockito.when(mockHttpServletRequest.getAttribute(ProxySamlResponseViewMapping.SAML_TOKEN))
                .thenReturn(EidasStringUtil.encodeToBase64(testRequest));
