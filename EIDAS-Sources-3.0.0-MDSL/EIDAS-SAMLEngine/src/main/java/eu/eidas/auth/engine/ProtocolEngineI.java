...
public interface ProtocolEngineI {
    ...
    @Nullable
    List<X509Certificate> getDecryptionCertificates() throws EIDASSAMLEngineException;
    ...
    @Nonnull
    List<X509Certificate> getSigningCertificates() throws EIDASSAMLEngineException;
