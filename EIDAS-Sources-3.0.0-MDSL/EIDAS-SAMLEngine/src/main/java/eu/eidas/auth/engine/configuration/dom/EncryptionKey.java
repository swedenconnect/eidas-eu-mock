...
public enum EncryptionKey {
    ...
    KEY_ENCRYPTION_ALGORITHM_FOR_KEY_TRANSPORT("key.encryption.algorithm.key.transport"),

    KEY_ENCRYPTION_ALGORITHM_FOR_KEY_TRANSPORT_DIGEST("key.encryption.algorithm.key.transport.digest"),

    KEY_ENCRYPTION_ALGORITHM_FOR_KEY_TRANSPORT_MGF("key.encryption.algorithm.key.transport.mgf"),

    KEY_ENCRYPTION_ALGORITHM_FOR_KEY_AGREEMENT("key.encryption.algorithm.key.wrapping"),

    KEY_ENCRYPTION_AGREEMENT_METHOD_ALGORITHM("key.encryption.agreement.method.algorithm"),
