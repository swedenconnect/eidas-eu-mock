...
public final class InstanceEntry {
    ...
    public InstanceEntry(@Nonnull String name, @Nonnull Map<String, ConfigurationEntry> configurationEntries) {
    ...
    @Nonnull
    public Map<String, ConfigurationEntry> getConfigurationEntries() {
