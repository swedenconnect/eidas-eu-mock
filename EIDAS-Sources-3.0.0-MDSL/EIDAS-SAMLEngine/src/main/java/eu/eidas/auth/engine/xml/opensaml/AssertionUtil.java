...
public final class AssertionUtil {
    ...
    public static final Assertion generateResponseAssertion(boolean isFailure,
        ...
        addSubjectToAssertion(isFailure, assertion, request, subjectNameId, subjectNameIdFormat, notOnOrAfter, ipAddress, responder, extensionFormat, currentTime);
    ...
    private static void addSubjectToAssertion(boolean isFailure,
        ...
        NameID nameId = getNameID(isFailure, subjectNameId, request.getNameIdFormat(), subjectNameIdFormat, responder, extensionFormat);
    ...
    private static NameID getNameID(boolean isFailure, String subject, String requestFormat, String responseFormat, String responder, SAMLExtensionFormat extensionFormat)
        ...
        if (isFailure) {
            ...
            if (StringUtils.isNotBlank(requestFormat) && !NameIDType.UNSPECIFIED.equals(requestFormat)) {
