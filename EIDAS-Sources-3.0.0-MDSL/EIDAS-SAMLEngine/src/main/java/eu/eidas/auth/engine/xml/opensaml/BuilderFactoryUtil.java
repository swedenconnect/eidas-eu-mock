...
public final class BuilderFactoryUtil {
    ...
    public static XMLObject buildXmlObject(QName qname) throws EIDASSAMLEngineException {
        ...
        if (builder == null) {
            throw new EIDASSAMLEngineException(EidasErrorKey.MESSAGE_FORMAT_UNSUPPORTED,
                    "Unable to instantiate BuilderFactory from qname " + qname);
        }
    ...
    public static Assertion generateAssertion(SAMLVersion version,
        ...
        Instant issueInstant = issueDateTime != null ? issueDateTime.toInstant() : null;
     ...
     * @throws EIDASSAMLEngineException in case of errors
     */
    public static AuthnRequest generateAuthnRequest(String identifier, SAMLVersion version, ZonedDateTime issueDateTime)
     ...
     * @throws EIDASSAMLEngineException in case of errors
     */
    public static AuthnStatement generateAuthnStatement(ZonedDateTime authnDateTime, AuthnContext authnContext)
            throws EIDASSAMLEngineException {
        // <saml:AuthnStatement>
        AuthnStatement authnStatement = (AuthnStatement) buildXmlObject(AuthnStatement.DEFAULT_ELEMENT_NAME);

        Instant authnInstant = authnDateTime != null ? authnDateTime.toInstant() : null;
    ...
    public static NameID generateNameID(String nameQualifier, String format, String spNameQualifier) {
        ...
        // optional
        if (!NameIDType.ENTITY.equals(format)) {
     ...
     * @throws EIDASSAMLEngineException in case of errors
     */
    public static Response generateResponse(String identifier, ZonedDateTime issueDateTime, Status status)
            throws EIDASSAMLEngineException {
     ...
     * @throws EIDASSAMLEngineException in case of errors
     */
    public static SubjectConfirmationData generateSubjectConfirmationData(ZonedDateTime notOnOrAfter,
                                                                          String recipient,
                                                                          String inResponseTo)
            throws EIDASSAMLEngineException {
