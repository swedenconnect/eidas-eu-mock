...
public class ProtocolEngineTest {
     ...
     * Test method for
     * {@link ProtocolEngine#validateSignature(AuthnRequest)}
     * when {@link HighLevelMetadataParamsI#getResponseSignatureCertificate(Response)} throws an {@link EIDASSAMLEngineException}
     * <p>
     * Must fail
     * and throw an {@link EIDASSAMLEngineException}
     */
...
//        expectedException.expectMessage(EidasErrorKey.INVALID_SIGNATURE_ALGORITHM.errorCode());
    ...
    /**
     * Test method for
     * {@link ProtocolEngine#checkKeyTransportAlgorithm(Response)}
    ...
    /**
     * Reflection for * {@link ProtocolEngine#checkKeyTransportAlgorithm(Response)}
     */
