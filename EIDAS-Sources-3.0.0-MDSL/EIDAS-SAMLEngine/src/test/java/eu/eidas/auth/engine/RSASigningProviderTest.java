...
public class RSASigningProviderTest {
     ...
     */
    @Test
    public void signBCVerifyPssSHA1forceDigest() throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
     ...
     */
    @Test
    public void signBCVerifyPssSHA1forceMgf1() throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
        exception.expect(InvalidAlgorithmParameterException.class);
