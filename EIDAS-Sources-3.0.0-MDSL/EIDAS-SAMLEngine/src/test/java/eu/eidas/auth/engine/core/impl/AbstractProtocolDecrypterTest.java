...
public class AbstractProtocolDecrypterTest {
    ...
    private static final Method RETRIEVE_DECRYPTION_CREDENTIALS_METHOD;

    static {
        try {
            RETRIEVE_DECRYPTION_CREDENTIALS_METHOD = AbstractProtocolDecrypter.class.getDeclaredMethod(
                    RETRIEVE_DECRYPTION_CREDENTIALS_METHOD_NAME
            );
     ...
     */
    @Test
    public void testRetrieveDecryptionCredentials() throws ProtocolEngineConfigurationException, InvocationTargetException, IllegalAccessException {
        ...
        Credential[] credentials = (Credential[])
                RETRIEVE_DECRYPTION_CREDENTIALS_METHOD.invoke(decrypter);
    ...
    private AbstractProtocolDecrypter generateAbstractProtocolDecrypter(String keystoreFileLocation, Boolean checkedValidityPeriod) throws ProtocolEngineConfigurationException {
        ...
        Set<KeyStore.PrivateKeyEntry> decryptionKeyAndCertificates = keyStoreContent.getPrivateKeyEntries();
