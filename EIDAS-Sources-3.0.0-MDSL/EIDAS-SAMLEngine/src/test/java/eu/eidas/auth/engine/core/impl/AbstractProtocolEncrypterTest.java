...
public class AbstractProtocolEncrypterTest {
    ...
    private final Set<X509Certificate> certificates = generateKeyStoreContent("/keyStoreWithMultiplePrivateKeyEntries.p12").getCertificates();
    ...
    public void testEncryptSamlResponseInvalidAssertions() throws EIDASSAMLEngineException {
        ...
        final Response authResponse = Mockito.mock(Response.class);
        X509Certificate destinationCertificate = new ArrayList<>(certificates).get(1);
        encrypter.encryptSamlResponse(authResponse, destinationCertificate, true);
    }
    ...
    private KeyStoreContent generateKeyStoreContent(String keystorepath) {
        ...
        try {
            ...
            LOGGER.error("KeyStoreContent has not been initialized correctly", e);
    ...
    private X509Certificate getRSACertificate() {
        ...
        return new ArrayList<>(certificates).get(0);
    }

    private EncryptionConfiguration encryptionConfiguration = new EncryptionConfiguration.Builder()
            ...
            .setEncryptionCertificates(AbstractProtocolEncrypterTest.this.certificates)
            .setEncryptionAlgorithmWhitelist(Set.of("sha512-rsa-MGF1"))
            .build();
