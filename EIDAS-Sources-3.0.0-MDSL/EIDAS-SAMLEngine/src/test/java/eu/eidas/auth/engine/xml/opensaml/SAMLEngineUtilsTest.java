...
import eu.eidas.auth.engine.configuration.dom.KeyContainerEntry;
...
public class SAMLEngineUtilsTest {
    ...
    public static KeyInfo createKeyInfo(KeyInfoGeneratorFactory keyInfoGenFac, X509Credential credential) throws EIDASSAMLEngineException
    {
        ...
        try {
            ...
            throw new EIDASSAMLEngineException(EidasErrorKey.SAML_ENGINE_UNTRUSTED_CERTIFICATE,"",e);
        }
    }
    ...
    public void getDigestMethodAlgorithmMissingXmlSignature() throws EIDASSAMLEngineException {
        ...
        expectedException.expectMessage(EidasErrorKey.INVALID_SIGNATURE_ALGORITHM.errorMessage());
    ...
    private AuthnRequest createSignedRequestThatIsMisleading(String actualSignedDigestAlgorithm) throws MarshallingException, SignatureException, EIDASSAMLEngineException, UnmarshallException {
        ...
        final KeyStoreConfigurator.KeyStoreConfigurationKeys configurationKeys = new KeyStoreConfigurator.KeyStoreConfigurationKeys(
                "1.keyStorePath",
                "1.keyStoreType",
                "1.keyStoreProvider",
                "1.keyStorePassword",
        ...
        final KeyStoreConfigurator.KeyStoreConfiguration configuration = KeyStoreConfigurator.getKeyStoreConfiguration(properties, configurationKeys,null);
        final KeyStoreContent keyStoreContent = new KeyStoreConfigurator(configuration).loadKeyStoreContent();
        final KeyContainerEntry containerEntry = keyStoreContent.getMatchingKeyEntry(properties.get("serialNumber"), properties.get("issuer"));
        final X509Credential privateSigningCredential = CertificateUtil.createCredential(containerEntry.getPrivateKeyEntry());
