                    ...
                    <form action="IndexPage" id="formTab2" method="post">
                        ...
                        <div class="form-group" id="eidasNameIdentifierDiv">
                            ...
                            <select name="eidasNameIdentifier" id="eidasNameIdentifier" class="form-control">
                                ...
                                <s:iterator value="nameIDFormats">
                        ...
                        <div class="form-group" id="otherloasIdDiv">
                            <label for="otherloas"><s:property value="%{getText('otherloasId')}"/></label>
                            <select name="otherloas" id="otherloas" class="form-control"
                                    title="Non notified LoAs" multiple="true">
                                <s:iterator value="nonNotifiedLoAs">
                                    <option value="<s:property value="uri" />">
                            ...
                            <s:iterator value="eidasAttributeList">
                                <s:if test="%{#LegalPerson.equalsIgnoreCase(PersonType)}">
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline-group">
                                            <div class="radio radio-info radio-inline">
                                                    <%--TODO EIDINT-8024 Remove deprecated legal person attributes from selectAttributes.jsp--%>
                        ...
                        <s:set var="containsOtherAttributes" value="false" />
                        <s:set var="definedPersonTypes">NaturalPerson, LegalPerson, RepresentativeLegalPerson, RepresentativeNaturalPerson</s:set>

                        <s:iterator value="eidasAttributeList" var="attribute">
                            <s:set var="found" value="false"/>

                            <s:iterator value="%{#definedPersonTypes.split(',')}" var="personType">
                                <s:if test="%{#personType.equalsIgnoreCase(attribute.PersonType)}">
                                    <s:set var="found" value="true"/>
                                </s:if>
                            </s:iterator>

                            <s:if test="%{!#found}">
                                <s:set var="containsOtherAttributes" value="true"/>
                            </s:if>
                        </s:iterator>

                        <s:if test="%{containsOtherAttributes}">
                            <h4><s:property value="%{getText('eidasOtherAttributes')}"/><a class="toggle" id="tab2_toggle2"></a></h4>
                            <div class="content" id="tab2_toggle2_content">
                                <s:iterator value="eidasAttributeList">
                                    <s:if test="%{#definedPersonTypes.toString().indexOf(PersonType) == -1}">
                                        <div class="form-group">
                                            <s:if test="%{value[0]!=''}">
                                                <input type="text" name="<s:property value="friendlyName"/>"
                                                       value="<s:property value="friendlyName"/>" id="input"
                        ...
                        <div class="content" id="tab2_toggle5_content">
                        ...
                        <div class="button-group">
                            <button type="button" id="submit_tab2"
