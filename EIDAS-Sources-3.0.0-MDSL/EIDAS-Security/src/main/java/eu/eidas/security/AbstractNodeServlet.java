...
public abstract class AbstractNodeServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        logServletCall(request, this.getClass().getName(), getLogger());
    ...
    private void logServletCall(HttpServletRequest request, final String className, final Logger logger){
