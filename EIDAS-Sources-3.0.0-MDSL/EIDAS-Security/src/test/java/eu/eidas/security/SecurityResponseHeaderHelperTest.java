...
public class SecurityResponseHeaderHelperTest {
    ...
    public void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        httpServletResponse = new HttpResponseTestWrapper();
    ...
    /**
     * Test method for {@link SecurityResponseHeaderHelper#populateResponseHeader(HttpServletRequest, HttpServletResponse)}
     ...
     */
    private final class HttpResponseTestWrapper extends HttpServletResponseWrapper {
        private Map<String, String> headers = new HashMap<>();

        private HttpResponseTestWrapper() {
