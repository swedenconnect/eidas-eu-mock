...
public class SimpleProtocolProcess {
    ...
    public final Map<String, String> JAXB_OPTIONS = Map.of(
            JAXBContext.JAXB_CONTEXT_FACTORY, "org.eclipse.persistence.jaxb.JAXBContextFactory"
    );
    ...
    public <T> T convertFromJson(StringReader jSonRequestString, Class<T> c) throws JAXBException {
        ...
        JAXBContext jaxbContext = JAXBContext.newInstance(new Class[]{c}, JAXB_OPTIONS);
    ...
    public String convert2Json(Object object) throws JAXBException {
        ...
        JAXBContext jaxbContext = JAXBContext.newInstance(new Class[]{object.getClass()}, JAXB_OPTIONS);
        // Create a marshaller
