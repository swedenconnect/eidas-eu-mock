...
public class TokenRedirectHelper {
    ...
    public static void setTokenRedirectAttributes(@Nonnull HttpServletRequest httpServletRequest, ILightResponse lightResponse, String redirectUrl) throws SpecificCommunicationException {
