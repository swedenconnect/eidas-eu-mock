...
# ENV variables
export EIDAS_CONNECTOR_CONFIG_REPOSITORY=${BASE_CONFIG_PATH}/${CONFIG_FOLDER}/connector/
export EIDAS_PROXY_CONFIG_REPOSITORY=${BASE_CONFIG_PATH}/${CONFIG_FOLDER}/proxy/
