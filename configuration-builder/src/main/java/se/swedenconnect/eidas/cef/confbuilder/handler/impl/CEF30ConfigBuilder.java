 ...
 */
public class CEF30ConfigBuilder implements EIDASNodeConfigBuilder {
  ...
  @Override public void buildConfiguration(
    ...
    System.out.println("Building configuration data for CEF node version 3.0.0 and later");
    ...
    // NameIdPolicies
    connectorEidasXml.update("connector.nameid.policies", getAcceptableNameIdPoliciesList(connectorProperties));
    // Services
  ...
  private String getAcceptableNameIdPoliciesList(ConnectorProperties connectorProperties) {
    final List<String> allowedNameIdPolicies = connectorProperties.getAllowedNameIdPolicies();
    if (allowedNameIdPolicies == null || allowedNameIdPolicies.isEmpty()) {
      return "";
    }
    StringBuilder b = new StringBuilder();
    b.append("  <!-- Connector allowed NameID policies -->\n");
    b.append("  <entry key=\"connector.nameid.formats\">");
    b.append(String.join(",", allowedNameIdPolicies));
    b.append("</entry>");
    return b.toString();
  }
