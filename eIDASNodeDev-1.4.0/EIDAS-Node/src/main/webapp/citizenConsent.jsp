            ...
            <div class="col-right-inner">
                ...
                <div class="col-right-content">
                    ...
                    <form id="consentSelector" name="consentSelector" method="post" action="${e:forHtml(redirectUrl)}">
                        ...
                        <p id="stepstatusjs" name="stepstatusjs" class="step-status"><fmt:message key="common.step"
                                                                                                  bundle="${i18n_eng}"/>
                            <span>3</span> | 3</p>
                    ...
                    <p id="buttongroupjsjs" name="buttongroupjsjs" class="box-btn jsOK">
                        <button type="button" id="buttonCancel" class="btn btn-opposite"><span><fmt:message
                                key="common.cancel" bundle="${i18n_eng}"/></span></button>
                        <button type="button" id="buttonNext" class="btn btn-next btn-submit"><span><fmt:message
                                key="common.submit" bundle="${i18n_eng}"/></span></button>
                    </p>
