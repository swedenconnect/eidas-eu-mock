        ...
        <div class="col-right">
            <div class="col-right-inner">
                ...
                <div class="col-right-content">
                    ...
                    <form id="consentSelector" name="consentSelector" method="post"
                                ...
                                <c:if test="${!eidasAttributes}">
                                                ...
                                                <c:if test="${attrItem.getKey().isRequired()}">
                                                    ...
                                                    <c:if test="${!fn:startsWith(fn:toLowerCase(displayAttr), 'false')}">
                                                        <li class="attr_stork_li_slider1">
                                                            <fmt:message key="${attrItem.getKey().getNameUri()}"
                                                                         bundle="${i18n_eng}"/>
                                                        </li>
                                                    </c:if>
                                                    <input id="consentSelector_${attrItem.getKey().getFriendlyName()}"
                                    ...
                                    <div id="noDataDiv_slider1" class="col-sm-6 one-column">
                                        <h3><fmt:message key="presentConsent.your" bundle="${i18n_eng}"/>
                                            <span><fmt:message key="presentConsent.serviceProvider"
                                                               bundle="${i18n_eng}"/></span>
                                            <fmt:message key="presentConsent.doesntRequest" bundle="${i18n_eng}"/>
                                            <span><fmt:message key="presentConsent.mandatory"
                                                               bundle="${i18n_eng}"/></span>
                                    ...
                                    <div id="noDataDiv_slider2" class="col-sm-6 one-column">
                                        <h3><fmt:message key="presentConsent.your" bundle="${i18n_eng}"/>
                                            <span><fmt:message key="presentConsent.serviceProvider"
                                                               bundle="${i18n_eng}"/></span>
                                            <fmt:message key="presentConsent.doesntRequest" bundle="${i18n_eng}"/>
                                            <span><fmt:message key="presentConsent.optional"
                                                               bundle="${i18n_eng}"/></span>
                                            <fmt:message key="presentConsent.information" bundle="${i18n_eng}"/>
                                        </h3>
                                    </div>
                    ...
                    <form id="cancelForm" name="cancelForm" method="post" action="${e:forHtml(redirectUrl)}"
                          class="jsOK" disabled="true">
                        <input type="hidden" id="SAMLResponse" name="SAMLResponse"
                               value="<c:out value='${e:forHtml(samlTokenFail)}'/>"/>
                        <token:token/>
                    </form>
                    <noscript>
                        <span id="mergedSlider">
                            <div class="row">
								<form id="consentSelectornojs" name="consentSelectornojs" method="post"
									...
									<div id="slider3">
                                        <h1 class="title">
                                            ...
                                            <c:if test="${eidasAttributes}">
                                                 <span><fmt:message key="presentConsent.levelOfAssurance"
                                                                    bundle="${i18n_eng}"/>
                                                <c:out value="${e:forHtml(LoA)}"/></span>
                                            </c:if>
                                            <c:if test="${!eidasAttributes}">
                                                <span><fmt:message key="presentConsent.qualityOfAssurance"
                                                                   bundle="${i18n_eng}"/>
											...
											<c:if test="${eidasAttributes}">
												<div class="col-sm-6"> <% /** Natural person */ %>
													...
													<c:forEach items="${attrList}" var="attrItem">
														<c:if test="${attrItem.getKey().isRequired() && attrItem.getKey().getPersonType().getValue().equals('NaturalPerson')}">
															<c:if test="${categoryIsDisplayed=='false'}">
																<h3><fmt:message key="presentConsent.natural"
                                                                                 bundle="${i18n_eng}"/>
															...
															<li>
																...
																<c:if test="${!fn:startsWith(fn:toLowerCase(displayAttr), 'false')}">
                                                                    <fmt:message
                                                                            key="${attrItem.getKey().getFriendlyName()}"
                                                                            bundle="${i18n_eng}"/>
                                                                </c:if>
																<input id="consentSelector_${attrItem.getKey().getFriendlyName()}"
                                                                       type="hidden"
                                                ...
                                                <div class="col-sm-6"> <% /** Legal person */ %>
													...
													<c:forEach items="${attrList}" var="attrItem">
														<c:if test="${attrItem.getKey().isRequired() && attrItem.getKey().getPersonType().getValue().equals('LegalPerson')}">
															<c:if test="${categoryIsDisplayed=='false'}">
																<h3><fmt:message key="presentConsent.legal"
                                                                                 bundle="${i18n_eng}"/>
																	<span><fmt:message key="presentConsent.person"
                                                                                       bundle="${i18n_eng}"/></span>
																</h3>
									...
									<div id="slider4">
													...
													<c:forEach items="${attrList}" var="attrItem">
														<c:if test="${!attrItem.getKey().isRequired() && attrItem.getKey().getPersonType().equals('NaturalPerson')}">
															...
															<li>
																...
																<c:if test="${!fn:startsWith(fn:toLowerCase(displayAttr), 'false')}">
                                                                    <p><fmt:message
                                                                            key="${attrItem.getKey().getNameUri()}"
                                                                            bundle="${i18n_eng}"/></p>
                                                                    <input class="js-switch"
                                                                           id="consentSelector_${attrItem.getKey().getFriendlyName()}"
                                                                           type="checkbox"
											...
											<c:if test="${!eidasAttributes}">
                                                ...
                                                <div id="noDataDiv_slider2" class="col-sm-6 one-column">
													<h3><fmt:message key="presentConsent.your" bundle="${i18n_eng}"/>
														<span><fmt:message key="presentConsent.serviceProvider"
                                                                           bundle="${i18n_eng}"/></span>
														<fmt:message key="presentConsent.doesntRequest"
                                                                     bundle="${i18n_eng}"/>
														<span><fmt:message key="presentConsent.optional"
                                                                           bundle="${i18n_eng}"/></span>
														<fmt:message key="presentConsent.information"
                                                                     bundle="${i18n_eng}"/>
													</h3>
												</div>
                                            </c:if>
										...
										<p class="step-status"><fmt:message key="common.step"
                                                                            bundle="${i18n_eng}"/> <span>1</span> | 2</p>
										<p class="box-btn">
								...
								<form id="cancelForm2" name="cancelForm" method="post"
