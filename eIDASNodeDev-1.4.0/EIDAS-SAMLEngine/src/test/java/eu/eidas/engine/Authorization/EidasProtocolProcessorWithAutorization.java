...
import eu.eidas.auth.engine.core.eidas.*;
 ...
 * @since 1.1
 */
public class EidasProtocolProcessorWithAutorization implements ProtocolProcessorI {
     ...
     */
    public static final EidasProtocolProcessorWithAutorization INSTANCE = new EidasProtocolProcessorWithAutorization(null, null);
     ...
     * The LOG.
     */
    private static final Logger LOG = LoggerFactory.getLogger(EidasProtocolProcessorWithAutorization.class);
    ...
    public EidasProtocolProcessorWithAutorization(@Nullable MetadataFetcherI metadataFetcher,
                                                  @Nullable MetadataSignerI metadataSigner) {
        this(EidasSpec.REGISTRY, AttributeRegistries.empty(), metadataFetcher, metadataSigner);
    }

    public EidasProtocolProcessorWithAutorization(@Nonnull AttributeRegistry additionalAttributeRegistry,
    ...
    public EidasProtocolProcessorWithAutorization(@Nonnull String eidasAttributesFileName,
        ...
        this.eidasAttributeRegistry = AttributeRegistries.fromFile(eidasAttributesFileName, defaultPath);
    ...
    public EidasProtocolProcessorWithAutorization(@Nullable AttributeRegistry eidasAttributeRegistry,
    ...
    private void addAuthorizationStatementToAssertion(@Nonnull Assertion assertion, String resource, String nameSpace, String action){
    ...
    public boolean checkMandatoryAttributes(@Nullable ImmutableAttributeMap immutableAttributeMap) {
        ...
        Set<AttributeDefinition<?>> mandatoryLegalAttributes =
                new HashSet<>(getFilteredAttributes(EidasProtocolProcessorWithAutorization.MANDATORY_LEGAL_FILTER));

        Set<AttributeDefinition<?>> mandatoryNaturalAttributes =
                new HashSet<>(getFilteredAttributes(EidasProtocolProcessorWithAutorization.MANDATORY_NATURAL_FILTER));
...
<saml2:AuthzDecisionStatement Decision="Permit"
            Resource="https://taxud.ec.europa.eu/uumds/customs_decisions">
            <saml2:Action Namespace=" https://taxud.ec.europa.eu/uumds ">MGM_APP</saml2:Action>
    ...
    */
    ...
    public Response marshallResponse(@Nonnull IAuthenticationRequest request,
        ...
        addAuthorizationStatementToAssertion(assertion, "testResource", "urn:testNamespace", "testAction");
