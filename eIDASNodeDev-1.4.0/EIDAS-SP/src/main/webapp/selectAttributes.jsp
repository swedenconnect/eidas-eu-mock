...
<div class="container">
    <div class="row">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="#tab-02" aria-controls="tab-02" role="tab"
                                                      data-toggle="tab">
        ...
        <div class="tab-content">
            ...
            <s:if test="%{eidasNodeOnly == false}">
                <div role="tabpanel" class="tab-pane fade" id="tab-01">
                    <div class="col-md-12">
                        <h2><s:property value="%{providerName}"/><span class="sub-title"><s:property
                                value="%{getText('storkMode')}"/></span></h2>
                    </div>
                        ...
                        <s:form action="IndexPage" id="formTab1">
                            ...
                            <div class="radio-inline-group">
                                <div class="radio radio-info radio-inline">
                                    ...
                                    <label for="check_all_Mandatory"><s:property
                                            value="%{getText('mandatoryId')}"/></label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" name="allType" id="check_all_Optional" value="false"
                                           checked="checked"/>
                                    <label for="check_all_Optional"><s:property
                                            value="%{getText('optionalId')}"/></label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" name="allType" id="check_all_NoRequest" value="none"/>
                                    <label for="check_all_NoRequest"><s:property
                            ...
                            <div class="content" id="tab1_toggle1_content">
                                <s:iterator value="storkAttributeList">
                                    <div class="form-group">
                                        <s:if test="%{value[0]!=''}">
                                            <input type="text" name="<s:property value="nameUri"/>"
                                                   value="<s:property value="friendlyName"/>" id="input"
                                                   class="form-control"/>
                                            <input type="text" name="<s:property value="nameUri"/>Value"
                                                   value="<s:property value="value[0]"/>" id="input"
                                                   class="form-control"/>
                                        </s:if>
                                        <s:else>
                                            <input type="text" name="<s:property value="nameUri"/>"
                                                   value="<s:property value="name"/>" id="input" class="form-control"/>
                                        </s:else>
                                        <div class="radio-inline-group">
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       id="Mandatory_<s:property value="friendlyName" />" value="true"/>
                                                <label for="Mandatory_<s:property value="nameUri" />"><s:property
                                                        value="%{getText('mandatoryId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       id="Optional_<s:property value="friendlyName" />" value="false"
                                                       checked="checked"/>
                                                <label for="Optional_<s:property value="nameUri" />"><s:property
                                                        value="%{getText('optionalId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       id="NoRequest_<s:property value="friendlyName" />" value="none"/>
                                                <label for="NoRequest_<s:property value="nameUri" />"><s:property
                                                        value="%{getText('doNotRequestId')}"/></label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button id="submit_tab1" type="button" class="btn btn-default btn-lg btn-block">Submit
                            </button>
                            <s:fielderror/>
                        </s:form>
                    </div>
                    ...
                    <s:form action="IndexPage" id="formTab2">
                        ...
                        <div class="form-group" id="spCountryDiv">
                            ...
                            <select name="eidasconnector" id="eidasconnector" class="form-control">
                                <option data-description="Choose an option"></option>
                                <s:iterator value="countries">
                                    <option value="<s:property value="metadataUrl"/>"
                                            data-image="img/flags/<s:property value="name"/>.gif"><s:property
                                            value="name"/></option>
                                </s:iterator>
                            </select>
                            ...
                            <s:iterator value="eidasAttributeList">
                                <s:if test="%{#NaturalPerson.equalsIgnoreCase(PersonType)}">
                                    <div class="form-group">
                                        <s:if test="%{value[0]!=''}">
                                            <input type="text" name="<s:property value="nameUri"/>"
                                                   value="<s:property value="nameUri"/>" id="input"
                                                   class="form-control"/>
                                            <input type="text" name="<s:property value="nameUri"/>Value"
                                                   value="<s:property value="value[0]"/>" id="input"
                                                   class="form-control"/>
                                        ...
                                        <div class="radio-inline-group">
                                            <div class="radio radio-info radio-inline">
                                                ...
                                                <label for="Mandatory_<s:property value="nameUri" />Eidas"><s:property
                                                        value="%{getText('mandatoryId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                ...
                                                <label for="Optional_<s:property value="nameUri" />Eidas"><s:property
                                                        value="%{getText('optionalId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       ...
                                                       value="none"/>
                                                <label for="NoRequest_<s:property value="nameUri" />Eidas"><s:property
                                                        value="%{getText('doNotRequestId')}"/></label>
                                            </div>
                        ...
                        <div class="radio-inline-group">
                            ...
                            <div class="radio radio-info radio-inline">
                                <input type="radio" name="allTypeEidas" id="check_all_NoRequestRepvEidas" value="none"
                                       checked="checked"/>
                                <label for="check_all_NoRequesRepvtEidas"><s:property
                                        value="%{getText('doNotRequestId')}"/></label>
                            </div>
                        </div>
                                        ...
                                        <div class="radio-inline-group">
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       ...
                                                       value="true"/>
                                                <label for="MandatoryRepv_<s:property value="nameUri" />Eidas"><s:property
                                                        value="%{getText('mandatoryId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       ...
                                                       value="false"/>
                                                <label for="OptionalRepv_<s:property value="nameUri" />Eidas"><s:property
                                                        value="%{getText('optionalId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                ...
                                                <label for="NoRequestRepv_<s:property value="nameUri" />Eidas"><s:property
                                                        value="%{getText('doNotRequestId')}"/></label>
                                            </div>
                                            <s:if test="%{isRequired()}"><span class="text-error">(*)</span></s:if>
                                        </div>
                        ...
                        <s:form action="redirectIndexPage" id="formTab3">
                            ...
                            <div class="radio-inline-group">
                                <div class="radio radio-info radio-inline">
                                    ...
                                    <label for="check_all_Mandatory2"><s:property
                                            value="%{getText('mandatoryId')}"/></label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" name="allType" id="check_all_Optional2" value="false"
                                           checked="checked"/>
                                    <label for="check_all_Optional2"><s:property
                                            value="%{getText('optionalId')}"/></label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" name="allType" id="check_all_NoRequest2" value="none"/>
                                    <label for="check_all_NoRequest2"><s:property
                                            value="%{getText('doNotRequestId')}"/></label>
                                </div>
                            </div>
                            ...
                            <div class="content" id="tab3_toggle1_content">
                                <s:iterator value="storkAttributeList">
                                    <div class="form-group">
                                        ...
                                        <s:else>
                                            <input type="text" name="<s:property value="name"/>"
                                                   value="<s:property value="friendlyName"/>" id="input"
                                                   class="form-control"/>
                                        </s:else>
                                        <div class="radio-inline-group">
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       id="2Mandatory_<s:property value="friendlyName" />"
                                                       value="true"/>
                                                <label for=2"Mandatory_<s:property value="nameUri" />"><s:property
                                                        value="%{getText('mandatoryId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       id="2Optional_<s:property value="friendlyName" />" value="false"
                                                       checked="checked"/>
                                                <label for="2Optional_<s:property value="nameUri" />"><s:property
                                                        value="%{getText('optionalId')}"/></label>
                                            </div>
                                            <div class="radio radio-info radio-inline">
                                                <input type="radio" name="<s:property value="nameUri" />Type"
                                                       id="2NoRequest_<s:property value="friendlyName" />"
                                                       value="none"/>
                                                <label for="2NoRequest_<s:property value="nameUri" />"><s:property
                                                        value="%{getText('doNotRequestId')}"/></label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button id="submit_tab3" type="button" class="btn btn-default btn-lg btn-block">Submit
                            </button>
                            <s:fielderror/>
                        </s:form>
                    </div>
