...
package eu.eidas.specificcommunication.tx;
 ...
 * @since 2.0
 */
public final class CommunicationCache extends AbstractCorrelationMap<String> {

    public CommunicationCache(final ConcurrentMapService concurrentMapService) {
