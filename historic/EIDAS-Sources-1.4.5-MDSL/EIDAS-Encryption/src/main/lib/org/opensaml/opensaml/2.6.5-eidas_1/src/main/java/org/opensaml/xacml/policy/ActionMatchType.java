...
public interface ActionMatchType extends XACMLObject {
    ...
    public static final String SCHEMA_TYPE_LOCAL_NAME = "ActionMatchType";
     ...
     * 
     * @return action attribute designator for this match
     */
     ...
     * 
     * @param attribute action attribute designator for this match
     */
